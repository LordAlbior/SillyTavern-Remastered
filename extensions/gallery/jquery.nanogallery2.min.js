...
!((e) => {
    ...
    return u && c
      ? l
        ? "rgb" +
          ...
          (u[3] < 0 && c[3] < 0
            ? ")"
            : "," + (u[3] > -1 && c[3] > -1 ? r(1e4 * ((c[3] - u[3]) * e + u[3])) / 1e4 : c[3] < 0 ? u[3] : c[3]) + ")")
        : "#" +
          (
            4294967296 +
            16777216 *
  ...
  function l() {
    (this.LightboxReOpen = () => {
      ...
      (this.ItemsSetSelectedValue = (e, t) => {
        for (var n = e.length, i = 0; i < n; i++) ge(e[i], t);
      }),
      (this.ItemsSelectedGet = () => {
      ...
      (this.ThumbnailToolbarOneCartUpdate = (e) => {
        $(e);
      });
    var l = (e) => {
    ...
    (this.Search = (e) => {
      ...
      (this.CloseViewer = () => (nt(null), !1)),
      (this.MinimizeToolbar = () => (je(), !1)),
      (this.MaximizeToolbar = () => (We(), !1)),
      (this.PaginationPreviousPage = () => (G(), !1)),
      (this.PaginationNextPage = () => (y(), !1)),
      (this.PaginationGotoPage = (e) => (
        e > 1 && e--, (u.GOM.pagination.currentPage = e), u.GOM.ScrollToTop(), L(), E(!0), !1
      )),
      (this.PaginationCountPages = () =>
    ...
    (u.I = []),
        ...
        SetEngine: () => {
          if (u.layout.internal) {
            ...
            if (null != u.tn.settings.getMosaic())
              return (
                (u.layout.engine = "MOSAIC"), (u.layout.support.rows = !0), void (u.layout.prerequisite.imageSize = !1)
              );
      ...
      (u.galleryMaxRows = { l1: 0, lN: 0, Get: () => u.galleryMaxRows[u.GOM.curNavLevel] }),
      (u.galleryMaxItems = { l1: 0, lN: 0, Get: () => u.galleryMaxItems[u.GOM.curNavLevel] }),
      (u.galleryFilterTags = { l1: 0, lN: 0, Get: () => u.galleryFilterTags[u.GOM.curNavLevel] }),
      (u.galleryFilterTagsMode = { l1: 0, lN: 0, Get: () => u.galleryFilterTagsMode[u.GOM.curNavLevel] }),
      (u.galleryDisplayMode = {
        l1: "FULLCONTENT",
        lN: "FULLCONTENT",
        Get: () => u.galleryDisplayMode[u.GOM.curNavLevel],
      }),
      (u.galleryLastRowFull = { l1: !1, lN: !1, Get: () => u.galleryLastRowFull[u.GOM.curNavLevel] }),
      (u.gallerySorting = { l1: "", lN: "", Get: () => u.gallerySorting[u.GOM.curNavLevel] }),
      (u.galleryDisplayTransition = {
        l1: "none",
        lN: "none",
        Get: () => u.galleryDisplayTransition[u.GOM.curNavLevel],
      }),
      (u.galleryDisplayTransitionDuration = {
        l1: 500,
        lN: 500,
        Get: () => u.galleryDisplayTransitionDuration[u.GOM.curNavLevel],
      }),
      ...
      (u.tn = {
        opt: {
          ...
          Get: (e) => u.tn.opt[u.GOM.curNavLevel][e],
        },
        scale: 1,
        labelHeight: { l1: 0, lN: 0, get: () => u.tn.labelHeight[u.GOM.curNavLevel] },
        defaultSize: {
          width: { l1: { xs: 0, sm: 0, me: 0, la: 0, xl: 0 }, lN: { xs: 0, sm: 0, me: 0, la: 0, xl: 0 } },
          height: { l1: { xs: 0, sm: 0, me: 0, la: 0, xl: 0 }, lN: { xs: 0, sm: 0, me: 0, la: 0, xl: 0 } },
          getWidth: () => u.tn.defaultSize.width[u.GOM.curNavLevel][u.GOM.curWidth],
          getOuterWidth: () => {
            ...
            return (
              ("right" != u.O.thumbnailLabel.get("position") && "left" != u.O.thumbnailLabel.get("position")) ||
                (e += u.tn.defaultSize.width[u.GOM.curNavLevel][u.GOM.curWidth]),
              e
            );
          },
          getHeight: () => u.tn.defaultSize.height[u.GOM.curNavLevel][u.GOM.curWidth],
          getOuterHeight: () =>
            u.tn.defaultSize.height[u.GOM.curNavLevel][u.GOM.curWidth] + 2 * u.tn.opt.Get("borderVertical"),
        },
        settings: {
          width: {
          ...
          mosaicCalcFactor: function (e, t) {
            for (var n = 1, i = 1, a = 0; a < u.tn.settings.mosaic[e][t].length; a++)
              (n = Math.max(n, this.mosaic[e][t][a].w)), (i = Math.max(i, this.mosaic[e][t][a].h));
      ...
      (u.CSStransformName = mt(["transform", "msTransform", "MozTransform", "WebkitTransform", "OTransform"])),
      ...
      (u.CSSperspective = mt(["perspective", "msPerspective", "MozPerspective", "WebkitPerspective", "OPerspective"])),
      ...
      (u.CSStransitionName = mt(["transition", "msTransition", "MozTransition", "WebkitTransition", "OTransition"])),
      (u.CSSanimationName = mt(["animation", "msAnimation", "MozAnimation", "WebkitAnimation", "OAnimation"])),
      (u.GalleryResizeThrottled = ((e, t, n) => {
        var i,
          a,
          o,
          r = null,
        ...
        return function () {
          ...
          return (
            ...
            (a = arguments),
            c <= 0 || c > t
              ? (r && (clearTimeout(r), (r = null)), (l = u), (o = e.apply(i, a)), r || (i = a = null))
        ...
        ScrollToTop: () => {
          ...
          if (
            ...
            (null !== u.$E.scrollableParent ||
              ((e = u.$E.base), (t = 20), (n = a()), (i = e.offset()).top >= n.t && i.top <= n.t + n.h - t) ||
      ...
      (u.VOM = {
        ...
        content: {
          previous: {
            vIdx: -1,
            $media: null,
            NGY2Item: () => u.I[u.VOM.items[u.VOM.content.previous.vIdx].ngy2ItemIdx],
          },
          current: { vIdx: -1, $media: null, NGY2Item: () => u.I[u.VOM.items[u.VOM.content.current.vIdx].ngy2ItemIdx] },
          next: { vIdx: -1, $media: null, NGY2Item: () => u.I[u.VOM.items[u.VOM.content.next.vIdx].ngy2ItemIdx] },
        },
        IdxNext: () => {
          var e = 0;
              ...
              if (this.firstDisplay)
                ...
                if (
                  ...
                  n + this.posX < this.vwidth
                    ...
                    : n + this.posX >= this.vwidth && (this.posX = this.vwidth - (n + this.oneTmbWidth));
                }
                this.PanGallery(0);
              }
          },
          PanGallery: function (e) {
            this.gwidth < u.VOM.$viewer.width() && ((this.posX = (u.VOM.$viewer.width() - this.gwidth) / 2), (e = 0)),
            ...
            for (var e, t = 0, n = u.VOM.ImageLoader.list, i = 0; i < n.length; i++)
              null != (e = n[i]) &&
                (e.image.width && e.image.height
                  ? ((u.VOM.ImageLoader.list[i] = null), e.callback(e.image.width, e.image.height, e.ngitem, e.checks))
    ...
    function m() {
      ...
      var e = 0,
        ...
        n = "";
      Object.hasOwn(t, "src") && (n = t.src.nodeValue),
        "" == n && Object.hasOwn(t, "data-ngthumb") && (n = t["data-ngthumb"].nodeValue);
    ...
    function g(e, t) {
      ...
      (u.GOM.curNavLevel = "lN"),
        ...
        u.I[n].contentIsLoaded ? (me(), (u.GOM.pagination.currentPage = 0), lt(t, ""), w(n)) : Z(t, g, e, t);
    }
    function f() {
      switch (u.galleryDisplayMode.Get()) {
        case "PAGINATION":
          u.layout.support.rows &&
            ...
            (() => {
              if ((u.$E.conTnBottom.css("opacity", 0), u.$E.conTnBottom.children().remove(), 0 == u.GOM.items.length))
                return;
    ...
    function O(e) {
        ...
        if (r > 0) {
          for (o = 0; o < r; o++) {
            ...
            jQuery.inArray(l, u.I[e].albumTagListSel) >= 0 &&
              ...
              jQuery('<div class="nGY2NavigationbarItem nGY2NavFilter' + c + '">' + s + " " + l + "</div>")
      ...
      "PAGINATION" == u.galleryDisplayMode.Get() &&
        ...
        u.galleryMaxRows.Get() > 0 &&
        (jQuery(
          '<div class="nGY2NavigationbarItem nGY2NavPagination">' + u.O.icons.navigationPaginationPrevious + "</div>",
        )
          .appendTo(u.GOM.navigationBar.$newContent)
          .click(() => {
            G();
          }),
        jQuery('<div class="nGY2NavigationbarItem nGY2NavPagination">' + u.O.icons.navigationPaginationNext + "</div>")
          .appendTo(u.GOM.navigationBar.$newContent)
          .click(() => {
            y();
          }));
    ...
    function y() {
      ...
      n < t - 1 ? n++ : (n = 0), (u.GOM.pagination.currentPage = n), ot("pageChanged"), u.GOM.ScrollToTop(), L(), E(!0);
    }
    function G() {
      var e = 0;
      X(), u.galleryMaxRows.Get() > 0 && (e = (u.GOM.items[u.GOM.items.length - 1].row + 1) / u.galleryMaxRows.Get());
      var t = Math.ceil(e),
        n = u.GOM.pagination.currentPage;
      n > 0 ? n-- : (n = t - 1), (u.GOM.pagination.currentPage = n), ot("pageChanged"), u.GOM.ScrollToTop(), L(), E(!0);
    }
    function M() {
      switch (
        ((u.GOM.displayInterval.from = 0), (u.GOM.displayInterval.len = u.I.length), u.galleryDisplayMode.Get())
      ) {
        case "PAGINATION":
          if (u.layout.support.rows) {
            const a = u.GOM.items.length;
            var e = u.GOM.pagination.currentPage * u.galleryMaxRows.Get(),
              t = e + u.galleryMaxRows.Get(),
              n = -1;
            u.GOM.displayInterval.len = 0;
            for (var i = 0; i < a; i++) {
              const a = u.GOM.items[i];
              a.row >= e &&
                a.row < t &&
                (-1 == n && ((u.GOM.displayInterval.from = i), (n = i)), u.GOM.displayInterval.len++);
            }
          }
          break;
        case "MOREBUTTON":
          if (u.layout.support.rows) {
            const e = u.GOM.items.length,
    ...
    function w(e) {
      ...
      if (
        (null !== t && ("function" == typeof t ? t(u.I[u.GOM.albumIdx]) : window[t](u.I[u.GOM.albumIdx])),
        u.layout.SetEngine(),
        (u.galleryResizeEventEnabled = !1),
        (u.GOM.albumIdx = -1),
                ...
                ? (u.tn.labelHeight[u.GOM.curNavLevel] = (() => {
                    ...
                    (e[t++] =
                      ...
                      1 == u.O.thumbnailLabel.get("display") &&
                        ((e[t++] = '  <div class="nGY2GThumbnailLabel" ' + u.tn.style.getLabel() + ">"),
                        (e[t++] =
                          '    <div class="nGY2GThumbnailAlbumTitle" ' + u.tn.style.getTitle() + ">aAzZjJ</div>"),
                        1 == u.O.thumbnailLabel.get("displayDescription") &&
                          (e[t++] =
                            '    <div class="nGY2GThumbnailDescription" ' + u.tn.style.getDesc() + ">aAzZjJ</div>"),
                        (e[t++] = "  </div>"));
                    e[t++] = "</div></div>";
                      ...
                      if (t.img.getAttribute("data-albumidx") == u.GOM.albumIdx) {
                        ...
                        for (const e in o)
                          Object.hasOwn(o, e) &&
                            ...
                            ((a.thumbs.width.l1[e] = i.imageWidth), (a.thumbs.height.l1[e] = i.imageHeight));
                        o = a.thumbs.width.lN;
                        for (const e in o)
                          Object.hasOwn(o, e) &&
                            e != u.GOM.curWidth &&
                            ...
                            ((a.thumbs.width.lN[e] = i.imageWidth), (a.thumbs.height.lN[e] = i.imageHeight));
                      }
                    }
                  }),
    ...
    function x() {
      ...
      if (((u.galleryResizeEventEnabled = !1), 0 == S()))
        return (
          (u.galleryResizeEventEnabled = !0), void (u.O.debugMode && console.log("GalleryResize1: " + (new Date() - e)))
        );
        ...
        case "JUSTIFIED":
          e = (() => {
            for (
              ...
              const n = u.GOM.items[y];
              if (1 == n.deleted) break;
              if (n.imageWidth > 0) {
                const i = n.imageWidth / n.imageHeight,
                  u = Math.floor(g * i);
                if (
        ...
        case "CASCADING":
          e = (() => {
            ...
            if (((u.GOM.lastFullRow = -1), "fillWidth" == u.O.thumbnailAlignment)) {
              var g = (a - 1) * o;
              (s = (t - g) / (a * c)) > 1 && a++, (g = (a - 1) * o), (s = Math.min((t - g) / (a * c), 1));
            }
            for (
              var f = (c = Math.round(c * s)) - m, b = Math.round(u.tn.opt.Get("baseGridHeight") * s), v = 0;
              v < h;
              v++
            ) {
              var O = u.GOM.items[v];
              ...
              if (O.imageHeight > 0 && O.imageWidth > 0) {
                ...
                if (((O.resizedContentWidth = f), (O.resizedContentHeight = O.resizedContentWidth * G), b > 0)) {
                  var M = Math.max(Math.trunc(O.resizedContentHeight / b), 1);
                  O.resizedContentHeight = b * M + (M - 1) * (p + r);
                }
                if (
                  ((O.height = O.resizedContentHeight + p + u.tn.labelHeight.get()), (O.width = c), (O.row = 0), 0 == n)
                )
                  (y = e * (c + o)), (i[e] = O.height + r), ++e >= a && ((e = 0), n++);
                else {
                  for (var w = 0, I = i[0], T = 1; T < a; T++) i[T] + 5 < I && ((I = i[T]), (w = T));
        ...
        case "MOSAIC":
          e = (() => {
            var e = u.GOM.cache.areaWidth,
              ...
              c = 0,
              h = 0;
            const d = u.tn.settings.getMosaic();
            for (var m = 0; m < o; m++) {
              const e = d[s];
          ...
          e = (() => {
            ...
            for (
              ...
              (w.top = t),
                ...
                (w.height = O),
                (w.width = h),
                "fillWidth" == u.O.thumbnailAlignment && ((w.resizedContentWidth = v), (w.resizedContentHeight = y)),
                (w.row = b),
    ...
    function E(e) {
        ...
        if (e.inDisplayArea) {
          if (
            ...
            if (
              ...
              const t = u.I[e.thumbnailIdx];
              null == t.$elt && _(t, e.thumbnailIdx, i), a.push({ idx: i, delay: n, top: e.top, left: e.left }), n++;
            }
      ...
      if (
        ...
        ("ROWS" == u.galleryDisplayMode.Get() ||
          ("FULLCONTENT" == u.galleryDisplayMode.Get() && u.galleryLastRowFull.Get() && -1 != u.GOM.lastFullRow)) &&
      ...
      var c = k(a);
      k(o),
        u.GOM.thumbnails2Display.forEach((e) => {
          !((e, t) => {
            function n(e, t) {
            ...
            switch (u.tn.opt.Get("displayTransition")) {
              case "RANDOMSCALE": {
                for (var o = [0.95, 1, 1.05, 1.1], r = [1, 2, 3, 4], l = n(0, 3); l == u.GOM.lastRandomValue; )
                  l = n(0, 3);
                u.GOM.lastRandomValue = l;
                const t = o[l];
                e.$elt.css({ "z-index": u.GOM.lastZIndex + r[l], "box-shadow": "0px 0px 5px 3px rgba(0,0,0,0.74)" }),
              ...
              case "SCALEUP": {
                ...
                0 == e && (e = 0.6), (i = { scale: e, opacity: 0 }), (a = { scale: 1, opacity: 1 });
                break;
              }
              case "SCALEDOWN": {
                let e = u.tn.opt.Get("displayTransitionStartVal");
    ...
    function k(e) {
      ...
      if (
        ("random" == n
          ...
          : ("rowByRow" == n && "JUSTIFIED" != u.layout.engine && "GRID" != u.layout.engine && (n = ""),
        ...
        for (var i = [], a = [], o = 0; o < t; o++)
          null == i[e[o].left] && ((i[e[o].left] = []), a.push(e[o].left)), i[e[o].left].push(e[o].idx);
    ...
    function D(e, t) {
      ...
      if (i.neverDisplayed) {
        ...
        if (
          ...
          ngimagesLoaded(o.$getElt(".nGY2TnImg2")).on("progress", (e, t) => {
        ...
        if (
          ...
          } else (i.displayed = !0), o.$elt.css({ display: "block", top: n, left: i.left, opacity: 1 }), H(o);
      ...
      if (
        ...
        (o.width == i.width && o.height == i.height) ||
          ...
          (o.width = i.width),
          (o.height = i.height),
          (o.resizedContentWidth == i.resizedContentWidth && o.resizedContentHeight == i.resizedContentHeight) ||
            ("albumUp" == o.kind ||
              (o.$getElt(".nGY2GThumbnailImage").css({ height: i.resizedContentHeight, width: i.resizedContentWidth }),
              "JUSTIFIED" == u.layout.engine &&
                o.$getElt(".nGY2GThumbnailImg").css({ height: i.resizedContentHeight, width: i.resizedContentWidth })),
    ...
    function N() {
      ...
      null != e.imageDominantColors && (t = "url('" + e.imageDominantColors + "')"),
        u.GOM.slider.hostItem.$getElt(".nGY2TnImgBackNext", !0).css({ "background-image": t, opacity: 1 }),
          ...
          e.tween({
            ...
            step: (e) => {
              null != u.GOM.slider.hostItem.$getElt()
                ? (u.GOM.slider.hostItem.CSSTransformSet(".nGY2TnImgBack", "translateX", -(100 - e.left) + "%"),
      ...
      if (((e.eltTransform = []), (e.eltFilter = []), (e.hoverInitDone = !1), (e.$Elts = []), "albumUp" != e.kind)) {
          ...
          1 == u.O.thumbnailLabel.get("display") &&
            ...
            "album" == e.kind
              ...
              : (i[a++] =
                  ...
                  l +
                  "</div>"),
            (i[a++] = '    <div class="nGY2GThumbnailDescription" ' + u.tn.style.getDesc() + ">" + z(e) + "</div>"),
            (i[a++] = "  </div>")),
          (i[a++] = ((e) => {
        ...
        !((e, t) => {
          ...
          !1 === u.O.thumbnailOpenInLightox && (a = "cursor:default;"),
            (n[i++] = A("") + '<div class="nGY2GThumbnail" style="display:none;opacity:0;' + a + '" >'),
      ...
      return (
        (n =
          "justified" == u.O.thumbnailAlignment
            ? Math.floor(e / t)
            : Math.floor(
                (e + u.tn.settings.GetResponsive("gutterWidth")) / (t + u.tn.settings.GetResponsive("gutterWidth")),
              )),
    ...
    function W() {
      if (-1 != u.GOM.albumIdx)
        for (var e = u.GOM.items.length, t = 0; t < e; t++) U(t), (u.I[u.GOM.items[t].thumbnailIdx].hovered = !1);
    }
    function j(e) {
    ...
    this.initiateGallery2 = (e, t) => {
      ...
      if (
        ...
        (() => {
          ...
          for (
            var e = ["image", "album"], t = ["topLeft", "topRight", "bottomLeft", "bottomRight"], n = 0;
            n < e.length;
            n++
          )
          ...
          void 0 !== u.O.thumbnailL1Label &&
            ...
            ("overImageOnBottom" == u.O.thumbnailL1Label.position &&
              ((u.O.thumbnailL1Label.valign = "bottom"), (u.O.thumbnailL1Label.position = "overImage")),
            "overImageOnMiddle" == u.O.thumbnailL1Label.position &&
              ((u.O.thumbnailL1Label.valign = "middle"), (u.O.thumbnailL1Label.position = "overImage")),
            "overImageOnTop" == u.O.thumbnailL1Label.position &&
              ((u.O.thumbnailL1Label.valign = "top"), (u.O.thumbnailL1Label.position = "overImage")));
          (u.O.thumbnailLabel.get = (e) =>
            "l1" == u.GOM.curNavLevel && void 0 !== u.O.thumbnailL1Label && void 0 !== u.O.thumbnailL1Label[e]
              ? u.O.thumbnailL1Label[e]
              : u.O.thumbnailLabel[e]),
            (u.O.thumbnailLabel.set = (e, t) => {
              "l1" == u.GOM.curNavLevel && void 0 !== u.O.thumbnailL1Label && void 0 !== u.O.thumbnailL1Label[e]
          ...
          (u.tn.opt.lN.crop = u.O.thumbnailCrop),
            ...
            (u.gallerySorting.l1 =
              null != u.O.galleryL1Sorting ? u.O.galleryL1Sorting.toUpperCase() : u.gallerySorting.lN),
            ...
            (u.galleryFilterTagsMode.l1 =
              null != u.O.galleryL1FilterTagsMode ? u.O.galleryL1FilterTagsMode : u.O.galleryFilterTagsMode),
          ...
          "boolean" == typeof u.O.thumbnailDisplayTransition &&
            (!0 === u.O.thumbnailDisplayTransition
              ? ((u.tn.opt.lN.displayTransition = "FADEIN"), (u.tn.opt.l1.displayTransition = "FADEIN"))
              : ((u.tn.opt.lN.displayTransition = "NONE"), (u.tn.opt.l1.displayTransition = "NONE")));
          "" !== u.O.fnThumbnailDisplayEffect &&
            ((u.tn.opt.lN.displayTransition = "CUSTOM"), (u.tn.opt.l1.displayTransition = "CUSTOM"));
          ...
          if (void 0 !== u.O.thumbnailBuildInit2)
            for (p = u.O.thumbnailBuildInit2.split("|"), n = 0; n < p.length; n++) {
              var g, f;
              if (3 == (g = p[n].trim().split("_")).length)
                ((f = le()).element = ae(g[0], "")), (f.property = g[1]), (f.value = g[2]), u.tn.buildInit.std.push(f);
            }
          ...
          if (void 0 !== b)
            switch (r(b)) {
              ...
              case "object": {
                let e = re();
                (e = jQuery.extend(e, b)), (e = ie(e.name, e)), null != e && u.tn.hoverEffects.level1.push(e);
                break;
              }
              case "array":
                for (n = 0; n < b.length; n++) {
                  let e = re();
                  (e = jQuery.extend(e, b[n])), (e = ie(e.name, e)), null != e && u.tn.hoverEffects.level1.push(e);
                }
                break;
              case "null":
                break;
          ...
          switch (r(v)) {
            ...
            case "object": {
              let e = re();
              (e = jQuery.extend(e, v)), (e = ie(e.name, e)), null != e && u.tn.hoverEffects.std.push(e);
              break;
            }
            case "array":
              for (n = 0; n < v.length; n++) {
                let e = re();
                (e = jQuery.extend(e, v[n])), (e = ie(e.name, e)), null != e && u.tn.hoverEffects.std.push(e);
              }
              break;
            case "null":
              break;
          ...
          0 == u.tn.hoverEffects.std.length &&
            (0 == u.tn.hoverEffects.level1.length && (u.O.touchAnimationL1 = !1), (u.O.touchAnimation = !1));
          ...
          for (var O = ["xs", "sm", "me", "la", "xl"], y = 0; y < O.length; y++)
            null != u.O["galleryMosaic" + O[y].toUpperCase()] &&
              ((u.tn.settings.mosaic.lN[O[y]] = JSON.parse(JSON.stringify(u.O["galleryMosaic" + O[y].toUpperCase()]))),
        ...
        (() => {
          ...
          (() => {
            ...
            window.requestAnimationFrame ||
              (window.requestAnimationFrame = (t, n) => {
        ...
        (() => {
          ...
          if (!u.O.lightboxStandalone) {
            u.$E.base.text(""),
              ...
              (() => {
                ...
                (a +=
                  n + ".nGY2Breadcrumb { background:" + i.background + "; border-radius:" + i.borderRadius + "; }\n"),
                ...
                "NUMBERS" != u.O.galleryPaginationMode
                  ? ((a +=
                      n + ".nGY2paginationDot { border:" + i.shapeBorder + "; background:" + i.shapeColor + ";}\n"),
                    (a +=
                      n +
            ...
            if (
              ((u.$E.conTnBottom = jQuery('<div class="nGY2GalleryBottom" ' + t + "></div>").appendTo(
                u.$E.conTnParent,
              )),
              u.O.portable)
            ) {
          ...
          if (
            ((u.$E.conConsole = jQuery('<div class="nGY2ConsoleParent"></div>').appendTo(u.$E.base)),
            (() => {
            ...
            switch (
              ((() => {
                se(u.O.thumbnailLabel, "lN"),
                  void 0 !== u.O.thumbnailL1Label ? se(u.O.thumbnailL1Label, "l1") : se(u.O.thumbnailLabel, "l1");
                u.O.thumbnailL1Label && u.O.thumbnailL1Label.display && se(u.O.thumbnailL1Label, "l1");
                ...
                for (t = 0; t < e.length; t++) {
                  if ("auto" != (n = u.tn.settings.height.lN[e[t]]))
                    (u.tn.defaultSize.height.lN[e[t]] = n), (u.tn.defaultSize.height.l1[e[t]] = n);
                  else {
        ...
        (() => {
          u.O.lightboxStandalone ||
                  ...
                  u.O.touchAutoOpenDelay > 0
                    ? (X(),
                      ...
                      (u.touchAutoOpenDelayTimerID = window.setInterval(() => {
                        window.clearInterval(u.touchAutoOpenDelayTimerID), Ge(u.GOM.items[t.GOMidx].thumbnailIdx, !0);
            ...
            u.O.locationHash &&
              jQuery(window).on("hashchange.nanogallery2." + u.baseEltID, () => {
                rt();
              }));
          if (
            (jQuery(window).on(
              "resize.nanogallery2." + u.baseEltID + " orientationChange.nanogallery2." + u.baseEltID,
              s(st, u.O.eventsDebounceDelay, !1),
            ),
            jQuery(window).on("scroll.nanogallery2." + u.baseEltID, s(ut, u.O.eventsDebounceDelay, !1)),
            !u.O.lightboxStandalone)
          ) {
            ...
            null !== e &&
              ...
              u.$E.scrollableParent.on("scroll.nanogallery2." + u.baseEltID, s(ut, u.O.eventsDebounceDelay, !1)));
          }
          (u.VOM.toolsHide = s(Ae, u.O.viewerHideToolsDelay, !1)),
            ...
            jQuery(window).bind("mousewheel wheel", (e) => {
            ...
            jQuery(window).bind("mousemove", (e) => {
              u.VOM.viewerDisplayed &&
          ...
          (() => {
            if (u.O.lightboxStandalone)
              (u.GOM.curNavLevel = "l1"),
                null == u.O.items
                  ? ne(jQuery("[data-nanogallery2-Lightbox"), u.$E.base[0].dataset.nanogallery2Lgroup)
                  : ee(),
                m();
    ...
    var J = {
      youtube: {
        ...
        thumbUrl: (e) => "https://img.youtube.com/vi/" + e + "/hqdefault.jpg",
        url: (e) => "https://www.youtube.com/embed/" + e,
        markup: (e) =>
      ...
      vimeo: {
        ...
        url: (e) => "https://player.vimeo.com/video/" + e,
        markup: (e) =>
      ...
      dailymotion: {
        ...
        thumbUrl: (e) => "https://www.dailymotion.com/thumbnail/video/" + e,
        url: (e) => "https://www.dailymotion.com/embed/video/" + e,
        markup: (e) =>
    ...
    function ee() {
      ...
      (u.I[0].contentIsLoaded = !0),
        jQuery.each(u.O.items, (n, a) => {
          var o = "";
          void 0 === (o = ht(a, "title")) && (o = "");
          var r = "";
          K((r = void 0 !== a["src" + dt().toUpperCase()] ? a["src" + dt().toUpperCase()] : a.src)) ||
            (r = u.O.itemsBaseURL + r);
          var l = "";
          void 0 !== a.srct && a.srct.length > 0 ? K((l = a.srct)) || (l = u.O.itemsBaseURL + l) : (l = r),
          ...
          if (
            ...
            for (n = 0; n < b.length; n++) {
              ...
              void 0 !== v && (K(v) || (v = u.O.itemsBaseURL + v), (p.url.l1[b[n]] = v), (p.url.lN[b[n]] = v)),
      ...
      (u.I[0].contentIsLoaded = !0),
        jQuery.each(t, (t, l) => {
          if (l.dataset.nanogallery2Lgroup == n && "SCRIPT" != l.nodeName) {
            ...
            [].forEach.call(l.attributes, (e) => {
              s[e.name.toLowerCase()] = e.value.trim();
            });
            var c = te(l);
            "" == c && "" != s.alt && (c = s.alt),
              jQuery.each(e(l).children(), (e, t) => {
                "" == c && (c = te(t)),
                  [].forEach.call(t.attributes, (e) => {
                    s[e.name.toLowerCase()] = e.value.trim();
                  }),
                  "" == c && "" != s.alt && (c = s.alt);
              });
            var h = "",
              d = dt().toUpperCase();
            Object.hasOwn(s, "data-ngsrc" + d) && (h = s["data-ngsrc" + d]),
              void 0 === (h = h || s["data-ngsrc"] || s.href) || K(h) || (h = u.O.itemsBaseURL + h);
            var m = "";
            if (
              (Object.hasOwn(s, "src") && (m = s.src),
              "" == m && Object.hasOwn(s, "data-ngthumb") && (m = s["data-ngthumb"]),
              "" == m && (m = h),
              ...
              var p = s["data-ngdesc"],
                ...
                b = s["data-ngtags"],
                v = "0";
              Object.hasOwn(s, "data-ngalbumid") && ((v = s["data-ngalbumid"]), !0);
              var O = r(h);
              "" != O && (c = O);
              ...
              if (
                ((y.thumbs = {
                  url: { l1: { xs: m, sm: m, me: m, la: m, xl: m }, lN: { xs: m, sm: m, me: m, la: m, xl: m } },
                  width: { l1: { xs: G, sm: G, me: G, la: G, xl: G }, lN: { xs: G, sm: G, me: G, la: G, xl: G } },
                ...
                for (t = 0; t < w.length; t++) {
                  if (Object.hasOwn(s, "data-ngthumb" + w[t])) {
                    var I = s["data-ngthumb" + w[t]];
                    K(I) || (I = u.O.itemsBaseURL + I), (y.url.l1[w[t]] = I), (y.url.lN[w[t]] = I);
                  }
                  if (Object.hasOwn(s, "data-ngthumb" + w[t] + "width")) {
                    G = parseInt(s["data-ngthumb" + w[t] + "width"]);
                    (y.width.l1[w[t]] = G), (y.width.lN[w[t]] = G);
                  }
                  if (Object.hasOwn(s, "data-ngthumb" + w[t] + "height")) {
    ...
    function oe(e) {
      for (var a = [], o = 0; o < e.length; o++)
        switch (e[o].name.toUpperCase()) {
          case "BORDERLIGHTER": {
            const i = t(ue().thumbnail.borderColor),
          ...
          case "LABELSLIDEUP":
            a.push(ie("label_translateY_100%_0%", e[o])), a.push(ie("label_translateY_100%_0%", e[o]));
            break;
          case "LABELSLIDEDOWN":
          ...
          case "DESCRIPTIONAPPEAR":
            ...
            break;
          case "SLIDERIGHT":
            a.push(ie("image_translateX_0%_100%", e[o])), a.push(ie("label_translateX_-100%_0%", i(e[o])));
            break;
          case "SLIDELEFT":
            a.push(ie("image_translateX_0%_-100%", e[o])), a.push(ie("label_translateX_100%_0%", i(e[o])));
            break;
          case "SLIDEUP":
            a.push(ie("image_translateY_0%_-100%", e[o])), a.push(ie("label_translateY_100%_0%", i(e[o])));
            break;
          case "SLIDEDOWN":
            a.push(ie("image_translateY_0%_100%", e[o])), a.push(ie("label_translateY_-100%_0%", i(e[o])));
            break;
          case "IMAGESCALE150":
        ...
        if (u.shoppingCart[n].idx == e)
          return (
            ...
            null !== (i = u.O.fnShoppingCartUpdated) &&
              ("function" == typeof i ? i(u.shoppingCart, u.I[e], t) : window[i](u.shoppingCart, u.I[e], t)),
    ...
    function fe(e) {
      ...
      (a +=
        ...
        (a +=
          ...
          "</div>"),
        (a +=
          '<div class="nGY2PopupOneItem" style="text-align:center;" data-share="vk">' + u.O.icons.shareVK + "</div>"),
        (a +=
    ...
    function be(e, t, n) {
      ...
      (i += '<div class="nGY2PopupCloseButton" style="font-size:0.9em;">' + u.O.icons.buttonClose + "</div>"),
        ...
        u.popup.$elt.find(".nGY2PopupCloseButton").on("click", (e) => {
    ...
    function ye(e, t) {
      ...
      for (var i = e.target || e.srcElement; i != u.$E.conTnParent[0]; ) {
        if (jQuery(i).hasClass("nGY2GThumbnail"))
          return "NONE" == n.action && (n.action = "OPEN"), (n.GOMidx = jQuery(i).data("index")), n;
        if (!t) {
    ...
    function Me(e) {
      ...
      for (var t = u.I[e], n = u.I.length, i = 0; i < n; i++) if (u.I[i].albumID == t.GetID()) return void Ie(i);
      Z(t.GetID(), Me, e, null);
    }
    function we(e) {
      switch (u.O.kind) {
        ...
        if (u.O.thumbnailOpenOriginal) we(u.I[e]);
          ...
          if (null === r)
            if (u.VOM.viewerDisplayed) {
              ...
              const e = u.VOM.content.current.NGY2Item();
    ...
    function Te() {
      if (u.O.viewerZoom && !u.VOM.viewerMediaIsChanged) {
        ...
        if ("img" == e.mediaKind && e.imageHeight > 0 && e.imageWidth > 0)
          return !1 === u.VOM.zoom.isZooming && ((u.VOM.zoom.userFactor = 1), (u.VOM.zoom.isZooming = !0)), !0;
      }
      return !1;
    }
    function xe(e) {
    ...
    function De(e, t, n, i) {
      i && ((u.VOM.panPosX = e), (u.VOM.panPosY = t)),
        ...
        (n.children().eq(1)[0].style[u.CSStransformName] =
          "translate(" + e + "px, " + t + "px) rotate(" + u.VOM.content.current.NGY2Item().rotationAngle + "deg)");
    }
    function Ne(e) {
      (u.GOM.firstDisplay = !1),
        jQuery("head").append(
      ...
      null != i &&
        "" != i &&
        (n += '<div class="nGY2ViewerAreaPrevious ngy2viewerToolAction" data-ngy2action="previous">' + i + "</div>");
      var a = u.O.icons.viewerImgNext;
      null != a &&
        "" != a &&
        (n += '<div class="nGY2ViewerAreaNext ngy2viewerToolAction" data-ngy2action="next">' + a + "</div>"),
      ...
      (u.VOM.content.previous.$media[0].style[u.CSStransformName] = "translate(-" + c.w + "px, 0px)"),
        ...
        (u.VOM.padding.H =
          parseInt(u.VOM.$content.css("padding-left")) + parseInt(u.VOM.$content.css("padding-right"))),
        (u.VOM.padding.V =
          parseInt(u.VOM.$content.css("padding-top")) + parseInt(u.VOM.$content.css("padding-bottom")));
      var d = "",
        m = " toolbarBackground";
      ...
      (u.VOM.$toolbar = jQuery(g).appendTo(u.VOM.$viewer)),
        ...
        (u.O.viewerToolbar.autoMinimize > 0 && u.O.viewerToolbar.autoMinimize >= u.GOM.cache.viewport.w)
          ? je()
          : We();
      for (
      ...
      (y += "</div></div>"),
        ...
        Re(),
        ngscreenfull.enabled && u.O.viewerFullscreen && (ngscreenfull.request(), (u.VOM.viewerIsFullscreen = !0)),
        (() => {
          if (((u.VOM.gallery.firstDisplay = !0), "none" != u.O.viewerGallery)) {
            ...
            (u.VOM.gallery.gwidth = (e + 2 * n) * u.VOM.items.length), (u.VOM.gallery.oneTmbWidth = e + 2 * n);
            var l =
          ...
          finish: () => {
            (u.VOM.viewerDisplayed = !0),
              ...
              null == u.VOM.hammertime &&
                ...
                u.VOM.hammertime.on("pan", (e) => {
                  if (Ve())
                    switch (
                      ...
                      case "zoom":
                        De(u.VOM.panPosX + e.deltaX, u.VOM.panPosY + e.deltaY, u.VOM.content.current.$media, !1),
                          u.VOM.toolsHide();
                        break;
                      case "media":
                        if (
                ...
                u.VOM.hammertime.on("panend", (e) => {
                  if (Ve()) {
                    switch (u.VOM.panMode) {
                      case "zoom":
                        (u.VOM.timeImgChanged = new Date().getTime()),
                          De(u.VOM.panPosX + e.deltaX, u.VOM.panPosY + e.deltaY, u.VOM.content.current.$media, !0);
                        break;
                      case "media": {
                        var t = !1;
                        u.VOM.panXOnly || (Math.abs(e.deltaY) > 50 && Math.abs(e.deltaX) < 50 && (nt(), (t = !0))),
                          t ||
                ...
                u.O.viewerZoom
                  ? (u.VOM.hammertime.add(new NGHammer.Tap({ event: "doubletap", taps: 2, interval: 250 })),
                    ...
                    u.VOM.hammertime.on("singletap", (e) => {
                      if (Ve()) {
                    ...
                    u.VOM.hammertime.on("doubletap", (e) => {
                      Ve() &&
                        (Ye(e.srcEvent),
                        -1 !== e.target.className.indexOf("nGY2ViewerMedia") &&
                          (u.VOM.zoom.isZooming
                    ...
                    u.VOM.hammertime.on("pinchend", (e) => {
                      e.srcEvent.stopPropagation(),
                        e.srcEvent.preventDefault(),
                        (u.VOM.timeImgChanged = new Date().getTime());
                    }),
                    u.VOM.hammertime.on("pinch", (e) => {
                      e.srcEvent.stopPropagation(),
                        e.srcEvent.preventDefault(),
    ...
    function Be(e) {
      ...
      (t += '<div class="nGY2PopupOneItemText">' + e.description + "</div>"),
        ...
        "" != e.exif.model &&
          (t += '<div class="nGY2PopupOneItemText">' + u.O.icons.config + " " + e.exif.model + "</div>");
    ...
    function Ue() {
      u.VOM.playSlideshow
        ...
        : ((u.VOM.playSlideshow = !0), qe(), u.VOM.$viewer.find(".playPauseButton").html(u.O.icons.viewerPause));
    }
    function We() {
      u.VOM.toolbarMode = "std";
      for (var e = "", t = u.O.viewerToolbar.standard.split(","), n = 0, i = t.length; n < i; n++) e += He(t[n]);
    ...
    function je() {
      if (null == u.O.viewerToolbar.minimized || "" == u.O.viewerToolbar.minimized) We();
        ...
        for (var e = "", t = u.O.viewerToolbar.minimized.split(","), n = 0, i = t.length; n < i; n++) e += He(t[n]);
        u.VOM.$toolbar.find(".toolbar").html(e), Xe();
      }
    }
    function Xe() {
      ...
      if (null != e) {
        ...
        void 0 !== t.title && "" != t.title
          ...
          void 0 !== t.description && "" != t.description
            ? (u.VOM.$viewer.find(".ngy2viewerToolAction").find(".description").html(t.description), (n = !0))
    ...
    function Qe(e) {
      if (((u.VOM.swipePosX = e), null == u.CSStransformName));
        ...
        if (u.O.imageTransition.startsWith("SWIPE")) {
          t.mediaTransition() && tt(u.VOM.content.previous, 1), n.mediaTransition() && tt(u.VOM.content.next, 1);
          var i = Math.min(Math.max(Math.abs(e) / u.VOM.window.lastWidth, 0.8), 1);
          if (("SWIPE" == u.O.imageTransition && (i = 1), e > 0)) {
            const a = u.VOM.window.lastWidth;
            t.mediaTransition() &&
        ...
        if ("SLIDEAPPEAR" == u.O.imageTransition)
          if (
            ...
            const i = -e / u.VOM.window.lastWidth;
            n.mediaTransition() && tt(u.VOM.content.next, i), t.mediaTransition() && tt(u.VOM.content.previous, 0);
          } else {
            const i = e / u.VOM.window.lastWidth;
            t.mediaTransition() && tt(u.VOM.content.previous, i), n.mediaTransition() && tt(u.VOM.content.next, 0);
          }
      }
    }
    function qe(e) {
            ...
            case "SWIPE2": {
              ...
              (i.$media[0].style[u.CSStransformName] = "translate(" + -l + "px, 0px) "),
                ...
                new NGTweenable().tween({
                  ...
                  attachment: { dT: e, new_content_item: i, dir: l, media_transition: i.NGY2Item().mediaTransition() },
                  duration: r,
                  easing: o,
                  step: (e, t) => {
                    if (
    ...
    function Ke(e) {
      ...
      u.VOM.content.current.$media.insertAfter(o.last()),
        "img" == n.mediaKind && 0 == n.imageWidth
          ? tt(u.VOM.content.current, 0)
          : (u.VOM.content.current.$media.children().eq(0).attr("class", "nGY2ViewerMediaLoaderHidden"),
            tt(u.VOM.content.current, 1)),
      ...
      (l = '<div class="nGY2ViewerMediaLoaderDisplayed"></div>'),
        ...
        tt(u.VOM.content.previous, 0),
        tt(u.VOM.content.next, 0),
        "img" == s.mediaKind ? u.VOM.ImageLoader.loadImage(et, s) : Ee(u.VOM.content.previous.$media),
        u.VOM.playSlideshow &&
    ...
    function et(e, t, n, i) {
      (n.imageWidth = e),
        ...
        u.VOM.content.previous.NGY2Item() == n &&
          u.VOM.content.previous.$media.children().eq(0).attr("class", "nGY2ViewerMediaLoaderHidden"),
        Ce();
    }
    function tt(e, t) {
      var n = e.NGY2Item(),
    ...
    function nt(e) {
      if ((null == e && (e = u.VOM.content.current.vIdx), (u.VOM.viewerMediaIsChanged = !1), u.VOM.viewerDisplayed)) {
        if (
          ...
          u.VOM.playSlideshow && (window.clearTimeout(u.VOM.playSlideshowTimerID), (u.VOM.playSlideshow = !1)),
          u.VOM.hammertime.destroy(),
          (u.VOM.hammertime = null),
          ngscreenfull.enabled && u.VOM.viewerIsFullscreen && ((u.VOM.viewerIsFullscreen = !1), ngscreenfull.exit()),
    ...
    function lt(e, t) {
      ...
      var i = location.hash;
      if (
        (u.O.debugMode && (console.log("newLocationHash2: " + n), console.log("location.hash: " + i)),
        ...
        if (-1 != u.GOM.albumIdx) {
          ...
          if ("MOSAIC" == u.layout.engine) {
            if (JSON.stringify(i.mosaic[e][t]) !== JSON.stringify(i.mosaic[e][n]))
              return (u.GOM.curWidth = n), (u.GOM.pagination.currentPage = 0), void w(u.GOM.albumIdx);
          } else if (
    ...
    function ht(e, t) {
      return "" != u.i18nLang && void 0 !== e[t + "_" + u.i18nLang] && e[t + "_" + u.i18nLang].length > 0
        ? e[t + "_" + u.i18nLang]
        : e[t];
    }
    function dt() {
   ...
   */ (e.nanogallery2 = function (e, t) {
    (this.$e = jQuery(e)),
      (this.e = e),
      this.$e.data("nanogallery2data", this),
      (this.init = () => {
        void 0 === window.NGY2Item &&
          ((window.NGY2Tools = (() => {
            ...
            return (
              (e.FilterAlbumName = function (e, t) {
                ...
                if (!(this.albumList.length > 0)) {
                  ...
                  if (null !== this.blockList)
                    for (a = 0; a < this.blockList.length; a++) if (-1 !== n.indexOf(this.blockList[a])) return !1;
                  return !0;
                }
                ...
                e.NanoConsoleLog.call(t, n),
                  null != t.$E.conConsole &&
                    ...
                    0 == i
                      ...
                      : t.$E.conConsole.append("<p>nanogallery2: " + n + " [" + t.baseEltID + "]</p>"));
              }),
              (e.NanoConsoleLog = (e, t) => {
              ...
              (e.AlbumPostProcess = function (t) {
                ...
                if ("" != n || i > 0) {
                  var a = this.I.filter((e) => e.albumID == t && "albumUp" != e.kind);
                  switch (n) {
                    case "RANDOM":
                      a = e.AreaShuffle(a);
                      break;
                  ...
                  i > 0 && a.length > i && a.splice(i - 1, a.length - i),
                    this.I.ngy2removeIf((e) => e.albumID == t && "albumUp" != e.kind),
          ...
          (window.NGY2Item = (() => {
            ...
            (t.Get = (e, t) => {
              ...
              (t.New = (e, n, i, o, r, l, s) => {
                ...
                if (null !== e.O.titleTranslationMap) {
                  const t = e.O.titleTranslationMap.find((e) => e.title === n);
                ...
                if ("" != h) {
                  ...
                  d > -1 && ((c.featured = !0), (n = n.substring(0, d) + n.substring(d + h.length, n.length))),
                    (d = i.toUpperCase().indexOf(h)) > -1 &&
                      ((c.featured = !0), (i = i.substring(0, d) + i.substring(d + h.length, i.length)));
                }
            ...
            function a(e, t) {
              return 1 == e.O.allowHTMLinData ? t : String(t).replace(/[&<>"'`=/]/g, (e) => i[e]);
            }
            function o(e, t) {
            ...
            return (
              ...
              (t.prototype.thumbSet = function (e, t, n, i, a) {
                ...
                if (void 0 === i || "" == i || null == i)
                  ...
                  void 0 === a || "" == a || null == a
                    ...
                    : ((this.thumbs.url[a][i] = e), (this.thumbs.height[a][i] = n), (this.thumbs.width[a][i] = t));
              ...
              (t.prototype.setMediaURL = function (e, t) {
                (this.src = e),
                  ...
                  "img" == t &&
                    (this.mediaMarkup =
                      '<img class="nGY2ViewerMedia" src="' + e + '" alt=" " itemprop="contentURL" draggable="false">');
              }),
              ...
              (t.prototype.CSSFilterApply = function (e) {
                ...
                if (null != t.$elt)
                  for (var i = 0; i < t.$elt.length; i++)
                    null != t.$elt[i] && ((t.$elt[i].style.WebkitFilter = n), (t.$elt[i].style.filter = n));
              }),
              ...
              (t.prototype.animate = function (e, t, i) {
                if (null != this.$getElt()) {
                  ...
                  (a.G = this.G),
                    ...
                    i
                      ? (null == this.eltEffect[e.element] && (this.eltEffect[e.element] = []),
                        ...
                        e.firstKeyframe &&
                          (this.eltEffect[e.element][e.type] = { initialValue: e.from, lastValue: e.from }),
                        (a.animeFrom = e.from),
                        (a.animeTo = e.to),
                  ...
                  for (
                    var o = ["translateX", "translateY", "translateZ", "scale", "rotateX", "rotateY", "rotateZ"], r = 0;
                    r < o.length;
                    r++
                  )
                    if (e.type == o[r]) {
                  ...
                  !i ||
                    ...
                    (this.G.GOM.lastZIndex++, this.$getElt(e.element).css("z-index", this.G.GOM.lastZIndex));
                  var s = new NGTweenable();
                  (a.tweenable = s),
                    s.tween({
                      attachment: a,
          ...
          (this.options = jQuery.extend(!0, {}, jQuery.nanogallery2.defaultOptions, t)),
          (this.nG2 = null),
          (this.nG2 = new l()),
          this.nG2.initiateGallery2(this.e, this.options);
      }),
      (this.test = () => {}),
      this.init();
  }),
          ...
          case "shoppingCartUpdate":
            ...
            for (var o = n, r = i, l = 0; l < a.shoppingCart.length; l++)
              if (a.shoppingCart[l].ID == o) {
                ...
                const e = a.I[a.shoppingCart[l].idx];
                a.ThumbnailToolbarOneCartUpdate(e),
                  0 == r && a.shoppingCart.splice(l, 1),
                  null !== (u = a.O.fnShoppingCartUpdated) &&
                    ("function" == typeof u ? u(a.shoppingCart, e, "api") : window[u](a.shoppingCart, e, "api"));
                break;
              }
            return a.shoppingCart;
            ...
            for (l = 0; l < a.shoppingCart.length; l++)
              if (a.shoppingCart[l].ID == s) {
                ...
                (a.shoppingCart[l].qty = 0),
                  ...
                  null !== (u = a.O.fnShoppingCartUpdated) &&
                    ("function" == typeof u ? u(a.shoppingCart, c, "api") : window[u](a.shoppingCart, c, "api"));
                break;
              }
            return a.shoppingCart;
          }
    ...
    (() => {
      ...
      i
        ? (Object.defineProperties(o, {
            isFullscreen: { get: () => Boolean(e[i.fullscreenElement]) },
            element: { enumerable: !0, get: () => e[i.fullscreenElement] },
            enabled: { enumerable: !0, get: () => Boolean(e[i.fullscreenEnabled]) },
          }),
    ...
    (() => {
      ...
      var t,
        n = (() => {
          ...
          function h(e, t) {
            var n;
            for (n in e) Object.hasOwn(e, n) && t(n);
          }
          function d(e, t) {
            return (
              h(t, (n) => {
          ...
          function p(e, n, i, a, o, r, l) {
            var s,
              ...
              h = e < r ? 0 : (e - r) / o;
            for (s in n)
              Object.hasOwn(n, s) && ((c = "function" == typeof (u = l[s]) ? u : t[u]), (n[s] = g(i[s], a[s], c, h)));
            return n;
          }
          function g(e, t, n, i) {
            return e + (t - e) * n(i);
          ...
          return (
            ...
            (O.prototype.stop = function (t) {
              return (
                ...
                t &&
                  (f(this, "beforeTween"),
                  p(1, this._currentState, this._originalState, this._targetState, 1, 0, this._easing),
                  f(this, "afterTween"),
            ...
            (O.prototype.dispose = function () {
              var e;
              for (e in this) Object.hasOwn(this, e) && delete this[e];
            }),
            (O.prototype.filter = {}),
            (O.prototype.formula = { linear: (e) => e }),
       ...
       */ n.shallowCopy(n.prototype.formula, {
        easeInQuad: (e) => e ** 2,
        easeOutQuad: (e) => -((e - 1) ** 2 - 1),
        easeInOutQuad: (e) => ((e /= 0.5) < 1 ? 0.5 * e ** 2 : -0.5 * ((e -= 2) * e - 2)),
        easeInCubic: (e) => e ** 3,
        easeOutCubic: (e) => (e - 1) ** 3 + 1,
        easeInOutCubic: (e) => ((e /= 0.5) < 1 ? 0.5 * e ** 3 : 0.5 * ((e - 2) ** 3 + 2)),
        easeInQuart: (e) => e ** 4,
        easeOutQuart: (e) => -((e - 1) ** 4 - 1),
        easeInOutQuart: (e) => ((e /= 0.5) < 1 ? 0.5 * e ** 4 : -0.5 * ((e -= 2) * e ** 3 - 2)),
        easeInQuint: (e) => e ** 5,
        easeOutQuint: (e) => (e - 1) ** 5 + 1,
        easeInOutQuint: (e) => ((e /= 0.5) < 1 ? 0.5 * e ** 5 : 0.5 * ((e - 2) ** 5 + 2)),
        easeInSine: (e) => 1 - Math.cos(e * (Math.PI / 2)),
        easeOutSine: (e) => Math.sin(e * (Math.PI / 2)),
        easeInOutSine: (e) => -0.5 * (Math.cos(Math.PI * e) - 1),
        easeInExpo: (e) => (0 === e ? 0 : 2 ** (10 * (e - 1))),
        easeOutExpo: (e) => (1 === e ? 1 : 1 - 2 ** (-10 * e)),
        easeInOutExpo: (e) =>
          0 === e ? 0 : 1 === e ? 1 : (e /= 0.5) < 1 ? 0.5 * 2 ** (10 * (e - 1)) : 0.5 * (2 - 2 ** (-10 * --e)),
        ...
        elastic: (e) => -1 * 4 ** (-8 * e) * Math.sin(((6 * e - 1) * (2 * Math.PI)) / 2) + 1,
        swingFromTo: (e) => {
          var t = 1.70158;
          return (e /= 0.5) < 1
            ? e * e * ((1 + (t *= 1.525)) * e - t) * 0.5
        ...
        easeFromTo: (e) => ((e /= 0.5) < 1 ? 0.5 * e ** 4 : -0.5 * ((e -= 2) * e ** 3 - 2)),
        easeFrom: (e) => e ** 4,
        easeTo: (e) => e ** 0.25,
      }),
        (() => {
          ...
          (n.setBezierFunction = (t, i, a, o, r) => {
            ...
            (n.unsetBezierFunction = (e) => {
              delete n.prototype.formula[e];
            });
        })(),
        ((t = new n())._filterArgs = []),
        (n.interpolate = (e, i, a, o, r) => {
          ...
          var h = ((e, t, i, a, o, r) => n.tweenProps(a, t, e, i, 1, r, o))(e, l, i, a, u, s);
        ...
        ((e) => {
          ...
          function c(e) {
            var t = ((e) => {
              ...
              return (h[0] = d(e.substr(0, 2))), (h[1] = d(e.substr(2, 2))), (h[2] = d(e.substr(4, 2))), h;
            })(e);
          ...
          function m(e, t, n) {
            var i = t.match(e),
              a = t.replace(e, l);
            if (i) for (var o, r = i.length, s = 0; s < r; s++) (o = i.shift()), (a = a.replace(l, n(o)));
            return a;
          }
          function p(e) {
            ...
            e.each(n, (e) => {
              var i = t[e],
                o = ((e, t) => {
                  ...
                  ((e, t) => {
                    for (var n, i = {}, a = t.length, o = 0; o < a; o++) (i[(n = t[o])] = e[n]), delete e[n];
                    return i;
                  })(t, n[e].chunkNames),
                  n[e].chunkNames,
                );
    ...
    ((e, t, n, i) => {
      ...
      function d(e, t, n) {
        ...
        if (e)
          ...
          else for (a in e) Object.hasOwn(e, a) && t.call(n, e[a], a, e);
      }
      function m(t, n, i) {
        ...
        "function" != typeof Object.assign
          ? function (e) {
              ...
              for (var t = Object(e), n = 1; n < arguments.length; n++) {
                var a = arguments[n];
                if (a !== i && null !== a) for (var o in a) Object.hasOwn(a, o) && (t[o] = a[o]);
              }
              return t;
            }
          : Object.assign;
      var p = m(
        ...
        g = m((e, t) => p(e, t, !0), "merge", "Use `assign`.");
      function f(e, t, n) {
        var i,
          o = t.prototype;
      ...
      function S(e, t, n) {
        ...
        return n && (i = t ? i.sort((e, n) => e[t] > n[t]) : i.sort()), i;
      }
      function L(e, t) {
      ...
      function P(e, t) {
        (this.manager = e),
          ...
          (this.domHandler = (t) => {
            v(e.options.enable, [e]) && this.handler(t);
          }),
          this.init();
      }
      function R(e, t, n) {
        ...
        (n.isFirst = !!r),
          ...
          ((e, t) => {
            ...
            (t.overallVelocityX = d.x),
              ...
              (t.rotation = l ? ((e, t) => U(t[1], t[0], _) + U(e[1], e[0], _))(l.pointers, a) : 0),
              ...
              ((e, t) => {
                ...
                if (8 != t.eventType && (u > 25 || l.velocity === i)) {
                  var c = t.deltaX - l.deltaX,
                    h = t.deltaY - l.deltaY,
                    d = z(u, c, h);
                  (a = d.x), (o = d.y), (n = s(d.x) > s(d.y) ? d.x : d.y), (r = B(c, h)), (e.lastInterval = t);
      ...
      f(Q, P, {
        handler: function (e) {
          ...
          1 & t && 0 === e.button && (this.pressed = !0),
            ...
            this.pressed &&
              (4 & t && (this.pressed = !1),
              this.callback(this.manager, t, { pointers: [e], changedPointers: [e], pointerType: V, srcEvent: e }));
        },
      });
      ...
      e.MSPointerEvent && !e.PointerEvent && ((J = "MSPointerDown"), (K = "MSPointerMove MSPointerUp MSPointerCancel")),
        f(ee, P, {
          handler: function (e) {
            var t = this.store,
              n = !1,
            ...
            1 & a && (0 === e.button || r) ? l < 0 && (t.push(e), (l = t.length - 1)) : 12 & a && (n = !0),
              l < 0 ||
                ((t[l] = e),
                this.callback(this.manager, a, { pointers: t, changedPointers: [e], pointerType: o, srcEvent: e }),
                n && t.splice(l, 1));
          },
        });
        ...
        handler: function (e) {
          ...
          if ((1 === t && (this.started = !0), this.started)) {
            ...
            12 & t && n[0].length - n[1].length == 0 && (this.started = !1),
              this.callback(this.manager, t, { pointers: n[0], changedPointers: n[1], pointerType: N, srcEvent: e });
          }
        },
      });
      ...
      function ue(e, t) {
        ...
        var a,
          ...
          l = [],
          s = this.target;
        if (((o = n.filter((e) => M(e.target, s))), 1 === t))
      ...
      f(se, P, {
        handler: function (e) {
          var t = re[e.type],
            n = ue.call(this, e, t);
          n && this.callback(this.manager, t, { pointers: n[0], changedPointers: n[1], pointerType: N, srcEvent: e });
        },
      });
      function ce() {
        P.apply(this, arguments);
      ...
      var pe = L(r.style, "touchAction"),
        ...
        Me = (() => {
          ...
          return (
            ["auto", "manipulation", "pan-y", "pan-x", "pan-x pan-y", "none"].forEach((i) => {
      ...
      (Te.prototype = {
        ...
        dropRecognizeWith: function (e) {
          return h(e, "dropRecognizeWith", this) || ((e = Le(e, this)), delete this.simultaneous[e.id]), this;
        },
        ...
        f(Ee, Ce, {
          ...
          directionTest: function (e) {
            ...
            return (
              a & t.direction ||
                (6 & t.direction
                  ? ((a = 0 === o ? 1 : o < 0 ? 2 : 4), (n = o != this.pX), (i = Math.abs(e.deltaX)))
                  : ((a = 0 === r ? 1 : r < 0 ? 8 : 16), (n = r != this.pY), (i = Math.abs(e.deltaY)))),
              (e.direction = a),
          ...
          attrTest: function (e) {
            return (
              Ce.prototype.attrTest.call(this, e) && (2 & this.state || (!(2 & this.state) && this.directionTest(e)))
            );
          },
          emit: function (e) {
          ...
          emit: function (e) {
            8 === this.state &&
              (e && 4 & e.eventType
                ...
                : ((this._input.timeStamp = u()), this.manager.emit(this.options.event, this._input)));
          },
        }),
        f(Ne, Ce, {
        ...
        f(Ve, Ce, {
          ...
          attrTest: function (e) {
            ...
            return (
              30 & n ? (t = e.overallVelocity) : 6 & n ? (t = e.overallVelocityX) : n & Y && (t = e.overallVelocityY),
      ...
      function Pe(e, t) {
        var n,
          i = e.element;
        i.style &&
          (d(e.options.cssProps, (a, o) => {
            (n = L(i.style, o)),
              t ? ((e.oldCssProps[n] = i.style[n]), (i.style[n] = a)) : (i.style[n] = e.oldCssProps[n] || "");
          }),
          t || (e.oldCssProps = {}));
      }
      (_e.prototype = {
  ...
  ((e) => {
    ...
    jQuery.nanogallery2.data_nano_photos_provider2 = function (e, t) {
      ...
      function o(e, t) {
        ...
        jQuery.each(t.album_content, (e, i) => {
          ...
          var h = i.ID,
            d = !1;
          if (
            ("album" == c && (s(l, h) || (d = !0), ("" == n.O.album && "" == n.O.photoset) || (d = !0)),
            "image" == c || !d)
          ) {
            var m = 0;
            ...
            g.setMediaURL(r, "img"),
              ...
              "album" == c ? (g.numberItems = i.cnt) : ((g.imageWidth = i.imgWidth), (g.imageHeight = i.imgHeight)),
      ...
      var n = e,
        i = (e, t, i, o) => {
            ...
            0 == e
              ...
              : (s =
                  "" != m
                    ...
                    : n.O.google2URL + "?nguserid=" + n.O.userID + "&ngalbumid=" + e + "&alt=json&v=3&kind=photo&" + d),
          ...
          try {
            ...
            jQuery
              .getJSON(s + "&callback=?", (s) => {
                if ("error" == s.nano_status)
                  return clearTimeout(p), r(!1), void l(n, "Could not retrieve Google data. Error: " + s.nano_message);
            ...
            "image" == t
              ? ((g = i.baseUrl),
                ...
                void 0 !== i.mediaMetadata.photo &&
                  (null != i.mediaMetadata.photo.exposureTime && (d.exif.exposure = i.mediaMetadata.photo.exposureTime),
                ...
                void 0 !== i.mediaMetadata.video &&
                  (null != i.mediaMetadata.video.cameraModel && (d.exif.model = i.mediaMetadata.video.cameraModel),
      ...
      function o(e, t, i, a, o, r) {
        for (var l = ["xs", "sm", "me", "la", "xl"], s = 0; s < l.length; s++) {
          ...
          if ("album" == a) {
            ...
            t.url[e][l[s]] =
              i.coverPhotoBaseUrl + "=h" + n.tn.settings.getH(e, l[s]) + "-w" + n.tn.settings.getW(e, l[s]);
          }
        }
        return t;
      }
    ...
    jQuery.nanogallery2.data_flickr = function (e, t) {
      var n = e,
        i = {
          ...
          thumbSize: "               sq",
          thumbAvailableSizes: [75, 100, 150, 240, 500, 640],
          thumbAvailableSizesStr: ["sq", "t", "q", "s", "m", "z"],
          photoSize: "0",
          photoAvailableSizes: [75, 100, 150, 240, 500, 640, 1024, 1024, 1600, 2048, 1e4],
          photoAvailableSizesStr: ["sq", "t", "q", "s", "m", "z", "b", "l", "h", "k", "o"],
        },
        a = (e, t, a, l) => {
          ...
          var g = setTimeout(() => {
            ...
            b = (i, d) => {
              jQuery
                .getJSON(i + "&page=" + d + "&jsoncallback=?", (v, O, y) => {
                  var G = 0;
                  if ("album" == m) {
                    if (void 0 !== v.stat && "fail" === v.stat)
                      return (
                        h(n, "Could not retrieve Flickr album list: " + v.message + " (code: " + v.code + ")."), !1
                      );
                    ...
                    if (void 0 !== v.stat && "fail" === v.stat)
                      return h(n, "Could not retrieve Flickr album: " + v.message + " (code: " + v.code + ")."), !1;
      ...
      function l(e, t, i) {
        ...
        for (var o = ["xs", "sm", "me", "la", "xl"], r = 0; r < o.length; r++)
          if ("auto" == n.tn.settings.width[i][o[r]] || "" == n.tn.settings.width[i][o[r]]) {
            const l = s(
              "height_",
              Math.ceil(n.tn.settings.height[i][o[r]] * n.tn.scale * a * n.tn.settings.mosaic[i + "Factor"].h[o[r]]),
              t,
            );
            ...
            const l = s(
              "width_",
              Math.ceil(n.tn.settings.width[i][o[r]] * n.tn.scale * a * n.tn.settings.mosaic[i + "Factor"].w[o[r]]),
              t,
            );
            (e.url[i][o[r]] = l.url), (e.width[i][o[r]] = l.width), (e.height[i][o[r]] = l.height);
          } else {
            let l = "height_",
              u = Math.ceil(
                n.tn.settings.height[i][o[r]] * n.tn.scale * a * n.tn.settings.mosaic[i + "Factor"].h[o[r]],
              );
            n.tn.settings.width[i][o[r]] > n.tn.settings.height[i][o[r]] &&
              ((l = "width_"),
              (u = Math.ceil(
                n.tn.settings.width[i][o[r]] * n.tn.scale * a * n.tn.settings.mosaic[i + "Factor"].w[o[r]],
              )));
            const c = s(l, u, t);
      ...
      function s(e, t, n) {
        for (var a = { url: "", width: 0, height: 0 }, o = 0, r = 0; r < i.thumbAvailableSizes.length; r++) {
          var l = n[e + i.photoAvailableSizesStr[r]];
          if (null != l && ((o = r), l >= t)) break;
        }
        var s = i.photoAvailableSizesStr[o];
        return (
          (a.url = n["url_" + s]), (a.width = parseInt(n["width_" + s])), (a.height = parseInt(n["height_" + s])), a
        );
      }
      var u = (e, t) => (
        "" != t &&
          ...
          (e = e.filter((e) => {
            var n = new RegExp(t, "i"),
              i = [e.tags];
            return Array.isArray(e.tags) && (i = e.tags), !i.some((e) => n.test(e));
          })),
        e
      );
