...
function createAssetBlock(asset, assetType, element) {
  ...
  const previewIcon =
    assetType === "extension" || assetType === "character" ? "fa-arrow-up-right-from-square" : "fa-headphones-simple";
  ...
  assetBlock.find(".tag").on("click", (e) => {
