...
class GSVITtsProvider {
  ...
  onSettingsChange() {
    ...
    this.settings.speed = parseFloat($("#gsvi_speed").val() as string);
    this.settings.temperature = parseFloat($("#gsvi_temperature").val() as string);
    this.settings.top_k = parseInt($("#gsvi_top_k").val() as string, 10);
    this.settings.top_p = parseFloat($("#gsvi_top_p").val() as string);
    this.settings.batch_size = parseInt($("#gsvi_batch_size").val() as string, 10);
    this.settings.stream = $("#gsvi_tts_streaming").is(":checked");
    this.settings.stream_chunk_size = parseInt($("#gsvi_stream_chunk_size").val() as string, 10);
