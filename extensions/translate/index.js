...
function loadSettings() {
  ...
  $(`#translation_target_language option[value="${extension_settings.translate.target_language}"]`).attr(
    "selected",
    "true",
  );
...
async function translateMessageReasoningEdit(messageId) {
  ...
  if (
    message.is_system ||
    (extension_settings.translate.auto_mode == autoModeOptions.NONE && message.extra?.reasoning_display_text)
  ) {
