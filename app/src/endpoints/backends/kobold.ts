...
router.post("/generate", async (request, response_generate) => {
...
router.post("/status", async (request, response) => {
  ...
  result.model =
    !koboldModelResponse || koboldModelResponse.result === "ReadOnly" ? "no_connection" : koboldModelResponse.result;
...
router.post("/embed", async (request, response) => {
  try {
