...
router.post("/props", async (request, response) => {
...
ollama.post("/download", async (request, response) => {
  try {
...
ollama.post("/caption-image", async (request, response) => {
  try {
...
llamacpp.post("/props", async (request, response) => {
  try {
...
llamacpp.post("/slots", async (request, response) => {
  try {
    if (!request.body.server_url) {
      return response.sendStatus(400);
    }
...
tabby.post("/download", async (request, response) => {
  try {
