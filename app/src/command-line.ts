...
export class CommandLineParser {
  ...
  getDefaultConfig(isGlobal: boolean) {
    ...
    return Object.freeze({
      ...
      getBrowserLaunchHostname: async () => {
  ...
  parse(args: string[]) {
    ...
    const configPath = isGlobal ? defaultConfig.configPath : (cliArguments.configPath ?? defaultConfig.configPath);
    ...
    const result = {
      ...
      listenAddressIPv6:
        cliArguments.listenAddressIPv6 ?? getConfigValue("listenAddress.ipv6", defaultConfig.listenAddressIPv6),
      listenAddressIPv4:
        cliArguments.listenAddressIPv4 ?? getConfigValue("listenAddress.ipv4", defaultConfig.listenAddressIPv4),
      enableIPv4:
      ...
      dnsPreferIPv6:
        cliArguments.dnsPreferIPv6 ?? getConfigValue("dnsPreferIPv6", defaultConfig.dnsPreferIPv6, "boolean"),
      heartbeatInterval:
      ...
      enableCorsProxy:
        cliArguments.corsProxy ?? getConfigValue("enableCorsProxy", defaultConfig.enableCorsProxy, "boolean"),
      disableCsrf:
        cliArguments.disableCsrf ?? getConfigValue("disableCsrfProtection", defaultConfig.disableCsrf, "boolean"),
      ...
      basicAuthMode:
        cliArguments.basicAuthMode ?? getConfigValue("basicAuthMode", defaultConfig.basicAuthMode, "boolean"),
      enableKeepAlive:
        cliArguments.enableKeepAlive ?? getConfigValue("enableKeepAlive", defaultConfig.enableKeepAlive, "boolean"),
      requestProxyEnabled:
        cliArguments.requestProxyEnabled ??
        getConfigValue("requestProxy.enabled", defaultConfig.requestProxyEnabled, "boolean"),
      requestProxyUrl:
        cliArguments.requestProxyUrl ?? getConfigValue("requestProxy.url", defaultConfig.requestProxyUrl),
      requestProxyBypass:
        cliArguments.requestProxyBypass ?? getConfigValue("requestProxy.bypass", defaultConfig.requestProxyBypass),
      ...
      getBrowserLaunchHostname: async function ({ useIPv6, useIPv4 }: { useIPv6: boolean; useIPv4: boolean }) {
