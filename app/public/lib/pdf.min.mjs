...
class util_FeatureTest {
  ...
  static get isOffscreenCanvasSupported() {
    return shadow(util_FeatureTest, "isOffscreenCanvasSupported", "undefined" != typeof OffscreenCanvas);
  }
  static get platform() {
    return "undefined" != typeof navigator && "string" == typeof navigator?.platform
      ? shadow(util_FeatureTest, "platform", {
          isMac: navigator.platform.includes("Mac"),
          isWindows: navigator.platform.includes("Win"),
          isFirefox: "string" == typeof navigator?.userAgent && navigator.userAgent.includes("Firefox"),
        })
      : shadow(util_FeatureTest, "platform", { isMac: !1, isWindows: !1, isFirefox: !1 });
  }
  static get isCSSRoundSupported() {
    return shadow(util_FeatureTest, "isCSSRoundSupported", globalThis.CSS?.supports?.("width: round(1.5px, 1px)"));
  }
}
...
class Util {
  ...
  static getAxialAlignedBoundingBox(t, e) {
    const i = Util.applyTransform(t, e),
      s = Util.applyTransform(t.slice(2, 4), e),
  ...
  static #e(t, e, i, s, n, a, r, o, l, h, d, c) {
    if (Math.abs(l) < 1e-12) {
      Math.abs(h) >= 1e-12 && Util.#t(t, e, i, s, n, a, r, o, -d / h, c);
      return;
    }
    const u = h ** 2 - 4 * d * l;
    if (u < 0) return;
    const p = Math.sqrt(u),
      g = 2 * l;
    Util.#t(t, e, i, s, n, a, r, o, (-h + p) / g, c);
    Util.#t(t, e, i, s, n, a, r, o, (-h - p) / g, c);
  }
  static bezierBoundingBox(t, e, i, s, n, a, r, o, l) {
    ...
    Util.#e(t, i, n, r, e, s, a, o, 3 * (3 * (i - n) - t + r), 6 * (t - 2 * i + n), 3 * (i - t), l);
    Util.#e(t, i, n, r, e, s, a, o, 3 * (3 * (s - a) - e + o), 6 * (e - 2 * s + a), 3 * (s - e), l);
    return l;
  }
}
let tt = null,
...
class PageViewport {
  ...
  get rawDims() {
    ...
    return shadow(this, "rawDims", { pageWidth: t[2] - t[0], pageHeight: t[3] - t[1], pageX: t[0], pageY: t[1] });
  }
  clone({
    scale: t = this.scale,
...
class PDFDateString {
  static toDateObject(t) {
    ...
    pt ||= /^D:(\d{4})(\d{2})?(\d{2})?(\d{2})?(\d{2})?(\d{2})?([Z|+|-])?(\d{2})?'?(\d{2})?'?/;
    const e = pt.exec(t);
    if (!e) return null;
...
class ImageManager {
  ...
  getFromCanvas(t, e) {
    ...
    i = { bitmap: s.transferToImageBitmap(), id: `image_${this.#y}_${this.#v++}`, refCounter: 1, isSvg: !1 };
    this.#w.set(t, i);
    this.#w.set(i.id, i);
    return i;
  }
...
class AnnotationEditorUIManager {
    ...
    return shadow(
      ...
      new KeyboardManager([
        ...
        [
          ...
          {
            checker: (t, { target: e }) => !(e instanceof HTMLButtonElement) && t.#ut.contains(e) && !t.isEnterHandled,
          },
        ],
        [
          [" ", "mac+ "],
          t.addNewEditorFromKeyboard,
          {
            checker: (t, { target: e }) => !(e instanceof HTMLButtonElement) && t.#ut.contains(document.activeElement),
          },
        ],
  ...
  keydown(t) {
    ...
    this.#nt === g.NONE || this.isEditorHandlingKeyboard || AnnotationEditorUIManager._keyboardManager.exec(this, t);
  }
  keyup(t) {
  ...
  #xt(t) {
    if (Object.entries(t).some(([t, e]) => this.#ht[t] !== e)) {
      this._eventBus.dispatch("annotationeditorstateschanged", { source: this, details: Object.assign(this.#ht, t) });
  ...
  updateToolbar(t) {
    t !== this.#nt && this._eventBus.dispatch("switchannotationeditormode", { source: this, mode: t });
  }
  updateParams(t, e) {
    if (this.#z) {
      switch (t) {
  ...
  undo() {
    this.#L.undo();
    this.#xt({ hasSomethingToUndo: this.#L.hasSomethingToUndo(), hasSomethingToRedo: !0, isEmpty: this.#Dt() });
  }
  redo() {
    this.#L.redo();
    this.#xt({ hasSomethingToUndo: !0, hasSomethingToRedo: this.#L.hasSomethingToRedo(), isEmpty: this.#Dt() });
  }
  addCommands(t) {
    this.#L.add(t);
  ...
  setUpDragSession() {
    if (this.hasSelection) {
      ...
      this.#H = new Map();
      for (const t of this.#at)
        this.#H.set(t, { savedX: t.x, savedY: t.y, savedPageIndex: t.pageIndex, newX: 0, newY: 0, newPageIndex: -1 });
    }
  }
  endDragSession() {
    if (!this.#H) return !1;
  ...
  getSelectionBoxes(t) {
    if (!t) return null;
    const e = document.getSelection();
    for (let i = 0, s = e.rangeCount; i < s; i++) if (!t.contains(e.getRangeAt(i).commonAncestorContainer)) return null;
    const { x: i, y: s, width: n, height: a } = t.getBoundingClientRect();
    let r;
    switch (t.getAttribute("data-main-rotation")) {
      case "90":
        r = (t, e, r, o) => ({ x: (e - s) / a, y: 1 - (t + r - i) / n, width: o / a, height: r / n });
        break;
      case "180":
        r = (t, e, r, o) => ({ x: 1 - (t + r - i) / n, y: 1 - (e + o - s) / a, width: r / n, height: o / a });
        break;
      case "270":
        r = (t, e, r, o) => ({ x: 1 - (e + o - s) / a, y: (t - i) / n, width: o / a, height: r / n });
        break;
      default:
...
class AltText {
  ...
  async setGuessedText(t) {
    if (null === this.#o) {
      this.#jt = t;
      this.#Wt = await AltText._l10nPromise.get("pdfjs-editor-new-alt-text-generated-alt-text-with-disclaimer")({
        generatedAltText: t,
      });
      this.#qt();
    }
  ...
  serialize(t) {
    ...
    return { altText: e, decorative: this.#Nt, guessedText: this.#jt, textWithDisclaimer: this.#Wt };
  }
  get data() {
  ...
  async #qt() {
    ...
    e.innerText = this.#Nt ? await AltText._l10nPromise.get("pdfjs-editor-alt-text-decorative-tooltip") : this.#o;
...
class AnnotationEditor {
  ...
  static get _defaultLineColor() {
    return shadow(AnnotationEditor, "_defaultLineColor", AnnotationEditor._colorManager.getHexCode("CanvasText"));
  }
  ...
  static initialize(t, e, i) {
    ...
    AnnotationEditor._l10nPromise ||= new Map([
      ...
      ...["pdfjs-editor-new-alt-text-generated-alt-text-with-disclaimer"].map((e) => [e, t.get.bind(t, e)]),
    ]);
  ...
  #Ae(t, e) {
    ...
    window.addEventListener("pointermove", this.#ve.bind(this, t), { passive: !0, capture: !0, signal: a });
  ...
  #ve(t, e) {
    ...
    if (g) {
      ...
      w = x = Math.max(Math.min(Math.hypot(b[0] - f[0] - _, b[1] - f[1] - E) / t, 1 / r, 1 / o), l / r, h / o);
    } else
      m
  ...
  #xe(t) {
    ...
    if (e) {
      ...
      window.addEventListener("pointermove", pointerMoveCallback, { passive: !0, capture: !0, signal: s });
    }
    const pointerUpCallback = () => {
      i.abort();
  ...
  static async deserialize(t, e, i) {
    const s = new AnnotationEditor.prototype.constructor({ parent: e, id: e.getNextId(), uiManager: i });
  ...
  keydown(t) {
    ...
    if (n !== s) {
      ...
      else if (n > s) for (let t = 0; t < n - s; t++) this.#Jt.firstChild.before(this.#Jt.lastChild);
      let t = 0;
      for (const i of e) {
  ...
  _reportTelemetry(t, e = !1) {
    if (e) {
      ...
      this._uiManager._eventBus.dispatch("reporttelemetry", { source: this, details: { type: "editing", data: t } });
    }
  }
...
class AnnotationStorage {
  ...
  get modifiedIds() {
    ...
    for (const e of this.#Pe.values())
      e instanceof AnnotationEditor && e.annotationElementId && e.serialize() && t.push(e.annotationElementId);
...
class FontLoader {
    ...
    if (t && !this.#Re.has(t.loadedName)) {
      ...
      if (this.isFontLoadingAPISupported) {
        ...
        try {
          ...
          warn(`Cannot load system font: ${t.baseFontName}, installing it could help to improve PDF rendering.`);
  ...
  _prepareFontLoadEvent(t, e) {
    function int32(t, e) {
      return (
        (t.charCodeAt(e) << 24) | (t.charCodeAt(e + 1) << 16) | (t.charCodeAt(e + 2) << 8) | (255 & t.charCodeAt(e + 3))
      );
    }
...
class FontFaceObject {
  ...
  getPathGenerator(t, e) {
    ...
    if (!Array.isArray(i) || 0 === i.length) return (this.compiledGlyphs[e] = (t, e) => {});
    const s = [];
...
if (e) {
  ...
  (async () => {
    const t = await import("fs"),
      ...
      s = await import("url");
    return new Map(Object.entries({ fs: t, http: e, https: i, url: s, canvas: undefined, path2d: undefined }));
  })().then(
    (t) => {
      vt = t;
      At.resolve();
...
class MeshShadingPattern extends BaseShadingPattern {
  ...
  _createMeshCanvas(t, e, i) {
    const s = Math.floor(this._bounds[0]),
      ...
      h = a / o,
      d = r / l,
      c = { coords: this._coords, colors: this._colors, offsetX: -s, offsetY: -n, scaleX: 1 / h, scaleY: 1 / d },
      u = o + 4,
      p = l + 4,
...
class TilingPattern {
  ...
  createPatternCanvas(t) {
    const { bbox: e, operatorList: i, paintType: s, tilingType: n, color: a, canvasGraphicsFactory: r } = this;
    ...
    if (w || x) {
      ...
      for (let t = 0; t <= u; t++) for (let i = 0; i <= m; i++) c.drawImage(e, n * t, a * i, n, a, 0, 0, n, a);
...
function putBinaryImageMask(t, e) {
  ...
  for (let e = 0; e < r; e++) {
    const i = e < a ? Ct : n;
    ({ srcPos: l } = convertBlackAndWhiteToRGBA({ src: h, srcPos: l, dest: d, width: s, height: i, nonBlackColor: 0 }));
...
class CanvasGraphics {
  ...
  composeSMask(t, e, i, s) {
    const n = s[0],
      ...
      o = s[3] - a;
    if (0 !== r && 0 !== o) {
      this.genericComposeSMask(e.context, i, r, o, e.subtype, e.backdrop, e.transferMap, n, a, e.offsetX, e.offsetY);
      t.save();
      t.globalAlpha = 1;
      t.globalCompositeOperation = "source-over";
  ...
  paintChar(t, e, i, s) {
    ...
    if (d) {
      (this.pendingTextPaths ||= []).push({ transform: getCurrentTransform(n), x: e, y: i, fontSize: l, addToPath: u });
    }
  }
      ...
      const i = t[1],
        ...
        n = {
          createCanvasGraphics: (t) =>
            new CanvasGraphics(t, this.commonObjs, this.objs, this.canvasFactory, this.filterFactory, {
...
for (const t in K)
  void 0 !== CanvasGraphics.prototype[t] && (CanvasGraphics.prototype[K[t]] = CanvasGraphics.prototype[t]);
class GlobalWorkerOptions {
  static #Ne = null;
  static #Oe = "";
  static get workerPort() {
    return GlobalWorkerOptions.#Ne;
  }
  static set workerPort(t) {
    if (!("undefined" != typeof Worker && t instanceof Worker) && null !== t)
      throw new Error("Invalid `workerPort` type.");
    GlobalWorkerOptions.#Ne = t;
  }
  static get workerSrc() {
    return GlobalWorkerOptions.#Oe;
  }
  static set workerSrc(t) {
    if ("string" != typeof t) throw new Error("Invalid `workerSrc` type.");
    GlobalWorkerOptions.#Oe = t;
  }
}
const Pt = 1,
  Ft = 2,
...
class MessageHandler {
    ...
    this._onComObjOnMessage = (t) => {
      ...
      if (e.callbackId) {
        ...
        new Promise((t) => {
          ...
          (s) => {
            i.postMessage({ sourceName: t, targetName: n, callback: Pt, callbackId: e.callbackId, data: s });
          },
          (s) => {
            i.postMessage({
              sourceName: t,
    ...
    return new ReadableStream(
      {
        start: (i) => {
          ...
          this.streamControllers[n] = { controller: i, startCall: l, pullCall: null, cancelCall: null, isClosed: !1 };
          o.postMessage(
            { sourceName: a, targetName: r, action: t, streamId: n, data: e, desiredSize: i.desiredSize },
            s,
          );
          return l.promise;
        },
        pull: (t) => {
          ...
          o.postMessage({ sourceName: a, targetName: r, stream: Ot, streamId: n, desiredSize: t.desiredSize });
          return e.promise;
        },
        cancel: (t) => {
          ...
          o.postMessage({ sourceName: a, targetName: r, stream: Dt, streamId: n, reason: wrapReason(t) });
          return e.promise;
        },
      },
      i,
  ...
  #He(t) {
    const e = t.streamId,
      ...
      o = {
        ...
        error(t) {
          ...
          if (!this.isCancelled) {
            this.isCancelled = !0;
            n.postMessage({ sourceName: i, targetName: s, stream: Nt, streamId: e, reason: wrapReason(t) });
          }
        },
    ...
    new Promise((e) => {
      ...
      (t) => {
        n.postMessage({ sourceName: i, targetName: s, stream: Ht, streamId: e, reason: wrapReason(t) });
      },
    );
  }
  #Be(t) {
    ...
    switch (t.stream) {
      ...
      case Ot:
        ...
        new Promise((t) => {
          ...
          (t) => {
            n.postMessage({ sourceName: i, targetName: s, stream: Bt, streamId: e, reason: wrapReason(t) });
          },
        );
        break;
      case Lt:
      ...
      case Dt:
        ...
        new Promise((e) => {
          ...
          (t) => {
            n.postMessage({ sourceName: i, targetName: s, stream: Rt, streamId: e, reason: wrapReason(t) });
          },
        );
...
class PDFDataTransportStream {
  constructor(t, { disableRange: e = !1, disableStream: i = !1 }) {
    ...
    if (n?.length > 0) {
      const t = n instanceof Uint8Array && n.byteLength === n.buffer.byteLength ? n.buffer : new Uint8Array(n).buffer;
...
function validateRangeRequestCapabilities({ responseHeaders: t, isHttp: e, rangeChunkSize: i, disableRange: s }) {
    ...
    let t = (function getFilenameFromContentDispositionHeader(t) {
      ...
      function rfc2047decode(t) {
        return !t.startsWith("=?") || /[\x00-\x19\x80-\xff]/.test(t)
          ? t
          : t.replaceAll(/=\?([\w-]*)\?([QqBb])\?((?:[^?]|\?(?!=))*)\?=/g, (t, e, i, s) => {
              if ("q" === i || "Q" === i)
                return textdecode(
                  e,
                  (s = (s = s.replaceAll("_", " ")).replaceAll(/=([0-9a-fA-F]{2})/g, (t, e) =>
...
function createResponseStatusError(t, e) {
  return 404 === t || (0 === t && e.startsWith("file:"))
    ...
    : new UnexpectedResponseException(`Unexpected server response (${t}) while retrieving PDF "${e}".`, t);
}
...
class TextLayer {
  ...
  static cleanup() {
    if (!(TextLayer.#vi.size > 0)) {
      TextLayer.#mi.clear();
      for (const { canvas: t } of TextLayer.#fi.values()) t.remove();
      TextLayer.#fi.clear();
    }
  }
  static #xi(t = null) {
    let e = TextLayer.#fi.get((t ||= ""));
    if (!e) {
      ...
      TextLayer.#fi.set(t, e);
      TextLayer.#bi.set(e, { size: 0, family: "" });
    }
    return e;
  }
  static #Si(t, e, i) {
    const s = TextLayer.#bi.get(t);
  ...
  static #yi() {
    ...
    TextLayer.#Ai = t.getBoundingClientRect().height;
    t.remove();
  }
  static #Ci(t, e) {
    const i = TextLayer.#mi.get(t);
    if (i) return i;
    const s = TextLayer.#xi(e);
...
function getDocument(t = {}) {
  ...
  t.canvasFactory && deprecated("`canvasFactory`-instance option, please use `CanvasFactory` instead.");
  t.filterFactory && deprecated("`filterFactory`-instance option, please use `FilterFactory` instead.");
  setVerbosityLevel(u);
  const B = {
...
class PDFPageProxy {
  ...
  getViewport({ scale: t, rotation: e = this.rotate, offsetX: i = 0, offsetY: s = 0, dontFlip: n = !1 } = {}) {
    return new PageViewport({ viewBox: this.view, scale: t, rotation: e, offsetX: i, offsetY: s, dontFlip: n });
  }
  ...
  render({
    ...
    const complete = (t) => {
        ...
        if (t) {
          ...
          this._abortOperatorList({ intentState: f, reason: t instanceof Error ? t : new Error(t) });
  ...
  _pumpOperatorList({ renderingIntent: t, cacheKey: e, annotationStorageSerializable: i, modifiedIds: s }) {
    const { map: n, transfer: a } = i,
      r = this._transport.messageHandler
        .sendWithStream(
          "GetOperatorList",
          { pageIndex: this._pageIndex, intent: t, cacheKey: e, annotationStorage: n, modifiedIds: s },
          a,
        )
        .getReader(),
...
class PDFWorker {
  ...
  get promise() {
    return e ? Promise.all([NodePackages.promise, this._readyCapability.promise]) : this._readyCapability.promise;
  }
  #Zi() {
    this._readyCapability.resolve();
  ...
  static fromPort(t) {
    ...
    const e = PDFWorker.#Ji?.get(t.port);
    if (e) {
  ...
  static get _setupFakeWorkerGlobal() {
    return shadow(
      ...
      (async () => {
        if (PDFWorker.#ts) return PDFWorker.#ts;
        return (await import(PDFWorker.workerSrc)).WorkerMessageHandler;
      })(),
    );
  }
}
class WorkerTransport {
  ...
  constructor(t, e, i, s, n) {
    ...
    this.fontLoader = new FontLoader({ ownerDocument: s.ownerDocument, styleElement: s.styleElement });
  ...
  getRenderingIntent(t, e = p.ENABLE, i = null, s = !1, n = !1) {
    ...
    return { renderingIntent: g, cacheKey: [g, m.hash, A].join("_"), annotationStorageSerializable: m, modifiedIds: b };
  }
  destroy() {
    ...
    t.on("commonobj", ([e, i, s]) => {
      ...
      switch (i) {
        case "Font": {
          ...
          const o = r && globalThis.FontInspector?.enabled ? (t, e) => globalThis.FontInspector.fontAdded(t, e) : null,
...
class InternalRenderTask {
  ...
  cancel(t = null, e = 0) {
    ...
    this.callback(t || new RenderingCancelledException(`Rendering cancelled, page ${this._pageIndex + 1}`, e));
  }
  operatorListChanged() {
...
class ColorConverters {
  ...
  static CMYK_HTML(t) {
    const e = ColorConverters.CMYK_RGB(t).slice(1);
    return ColorConverters.RGB_HTML(e);
  }
...
class XfaLayer {
        ...
        if (null !== a.value) {
          ...
          for (const t of i.children)
            t.attributes.value === a.value
              ...
              : Object.hasOwn(t.attributes, "selected") && delete t.attributes.selected;
        }
        t.addEventListener("input", (t) => {
  ...
  static setAttributes({ html: t, element: e, storage: i = null, intent: s, linkService: n }) {
    ...
    i && a.dataId && XfaLayer.setupStorage(t, a.dataId, e, i);
  }
  static render(t) {
    ...
    s.attributes && XfaLayer.setAttributes({ html: a, element: s, intent: n, linkService: i });
    const r = "richText" !== n,
      o = t.div;
    o.append(a);
    if (t.viewport) {
    ...
    for (; h.length > 0; ) {
      ...
      const c = o?.attributes?.xmlns ? document.createElementNS(o.attributes.xmlns, d) : document.createElement(d);
      a.append(c);
      o.attributes && XfaLayer.setAttributes({ html: c, element: o, storage: e, intent: n, linkService: i });
...
class AnnotationElement {
  ...
  _createQuadrilaterals() {
    ...
    for (let i = 2, s = t.length; i < s; i += 8) {
      ...
      u.append(p);
      r?.push(`<rect vector-effect="non-scaling-stroke" x="${g}" y="${m}" width="${f}" height="${b}"/>`);
    }
    if (this.#ps) {
      r.push("</g></svg>')");
    ...
    if (this._fieldObjects)
      t.onclick = () => {
        ...
        if (0 !== t.length || 0 !== s.length) {
          ...
          for (const t of Object.values(this._fieldObjects)) for (const i of t) e.has(i.id) === n && a.push(i);
  ...
  _setEventListener(t, e, i, s, n) {
    i.includes("mouse")
      ? t.addEventListener(i, (t) => {
          this.linkService.eventBus?.dispatch("dispatcheventinsandbox", {
            source: this,
            detail: { id: this.data.id, name: s, value: n(t), shift: t.shiftKey, modifier: this._getKeyModifier(t) },
          });
        })
      : t.addEventListener(i, (t) => {
          if ("blur" === i) {
      ...
      if (this.enableScripting && this.hasJSActions) {
        ...
        this.data.actions?.Keystroke &&
          i.addEventListener("beforeinput", (t) => {
            ...
            this.linkService.eventBus?.dispatch("dispatcheventinsandbox", {
              source: this,
              detail: { id: e, name: "Keystroke", value: n, change: i || "", willCommit: !1, selStart: l, selEnd: h },
            });
          });
...
class PopupElement {
  ...
  render() {
    ...
    if (this.#Ts) {
      ...
      if (CSS.supports("background-color", "color-mix(in srgb, red 30%, white)"))
        ...
        const e = 0.7;
        t.style.backgroundColor = Util.makeHexColor(...this.#Ts.map((t) => Math.floor(e * (255 - t) + t)));
      }
    }
    const e = document.createElement("span");
    e.className = "header";
  ...
  #js(t) {
    const e = [],
      i = { str: t, html: { name: "div", attributes: { dir: "auto" }, children: [{ name: "p", children: e }] } },
      s = { style: { color: this.#Us, fontSize: this.#zs ? `calc(${this.#zs}px * var(--scale-factor))` : "" } };
...
class FreeTextEditor extends AnnotationEditor {
  ...
  static initialize(t, e) {
    ...
    FreeTextEditor._internalPadding = parseFloat(i.getPropertyValue("--freetext-padding"));
  }
  static updateDefaultParams(t, e) {
    switch (t) {
  ...
  getInitialTranslation() {
    ...
    return [-FreeTextEditor._internalPadding * t, -(FreeTextEditor._internalPadding + this.#zs) * t];
  }
  rebuild() {
    if (this.parent) {
      super.rebuild();
  ...
  editorDivPaste(t) {
    ...
    if (r.nodeType === Node.TEXT_NODE) {
      ...
      if (t !== this.editorDiv) {
        let e = l;
        for (const i of this.editorDiv.childNodes) i !== t ? e.push(FreeTextEditor.#dn(i)) : (e = h);
      }
  ...
  static async deserialize(t, e, i) {
    ...
    const n = await AnnotationEditor.deserialize(t, e, i);
    n.#zs = t.fontSize;
  ...
  #gn(t) {
    ...
    return (
      this._hasBeenMoved || t.value !== e || t.fontSize !== i || t.color.some((t, e) => t !== s[e]) || t.pageIndex !== n
    );
  }
  renderAnnotationElement(t) {
...
class FreeOutliner {
  ...
  toSVGPath() {
    ...
    u.push(`L${(i[0] - n) / r} ${(i[1] - a) / o} L${l} ${h} L${d} ${c} L${(s[0] - n) / r} ${(s[1] - a) / o}`);
...
class FreeHighlightOutline extends Outline {
  ...
  getNewOutline(t, e) {
    ...
    for (let t = 2; t < this.#Ln.length; t += 2) g.add({ x: this.#Ln[t] * d + u, y: this.#Ln[t + 1] * c + p });
...
class ColorPicker {
  ...
  _moveToNext(t) {
    this.#na ? (t.target !== this.#Vn ? t.target.nextSibling?.focus() : this.#Kn.firstChild?.focus()) : this.#ea(t);
  }
  _moveToPrevious(t) {
...
class HighlightEditor extends AnnotationEditor {
  ...
  #ya({ highlightOutlines: t, highlightId: e, clipPathId: i }) {
    ...
    if (e >= 0) {
      ...
      this.parent.drawLayer.updateBox(this.#v, HighlightEditor.#_a(this.#pa.box, (e - this.rotation + 360) % 360));
  ...
  #wa(t = this.parent) {
    if (null === this.#v) {
      ({ id: this.#v, clipPathId: this.#la } = t.drawLayer.highlight(this.#pa, this.color, this.#fa));
  ...
  render() {
    ...
    this.#ga
      ...
      : this.div.addEventListener("keydown", this.#Ma.bind(this), { signal: this._uiManager._signal });
  ...
  static startHighlighting(t, e, { target: i, x: s, y: n }) {
    ...
    i.addEventListener("pointermove", HighlightEditor.#Ra.bind(HighlightEditor, t), { signal: d });
    HighlightEditor._freeHighlight = new FreeOutliner(
      { x: s, y: n },
      [a, r, o, l],
      t.scale,
    ...
    ({ id: HighlightEditor._freeHighlightId, clipPathId: HighlightEditor._freeHighlightClipId } = t.drawLayer.highlight(
      HighlightEditor._freeHighlight,
  ...
  static #Ra(t, e) {
    HighlightEditor._freeHighlight.add(e) &&
      t.drawLayer.updatePath(HighlightEditor._freeHighlightId, HighlightEditor._freeHighlight);
  }
  static #Da(t, e) {
    HighlightEditor._freeHighlight.isEmpty()
      ? t.drawLayer.removeFreeHighlight(HighlightEditor._freeHighlightId)
  ...
  static async deserialize(t, e, i) {
    ...
    const { color: n, quadPoints: a, inkLists: r, opacity: o } = t,
      l = await AnnotationEditor.deserialize(t, e, i);
...
class InkEditor extends AnnotationEditor {
  ...
  #br(t, e, i, s) {
    ...
    for (const e of this.paths) {
      ...
      n.push({ bezier: InkEditor.#mr(i, s, this.rotation), points: InkEditor.#mr(a, s, this.rotation) });
    }
    return n;
  }
  #Ar() {
  ...
  static async deserialize(t, e, i) {
    ...
    const s = await AnnotationEditor.deserialize(t, e, i);
...
class StampEditor extends AnnotationEditor {
  ...
  static get supportedTypesStr() {
    return shadow(StampEditor, "supportedTypesStr", StampEditor.supportedTypes.join(","));
  }
  static isHandlingMimeForPasting(t) {
    return StampEditor.supportedTypes.includes(t);
  }
  static paste(t, e) {
  ...
  #Pr() {
    ...
    if (this.#Cr)
      if (this._uiManager.useNewAltTextWhenAddingImage && this._uiManager.useNewAltTextFlow && this.#vr) {
        this._editToolbar.hide();
  ...
  async mlGuessAltText(t = null, e = !0) {
    ...
    const { data: s, width: n, height: a } = t || this.copyCanvas(null, null, !0).imageData,
      r = await i.guess({ name: "altText", request: { data: s, width: n, height: a, channels: s.length / (n * a) } });
  ...
  #Ya() {
    ...
    this.addContainer(l);
    (this._uiManager.useNewAltTextWhenAddingImage && this._uiManager.useNewAltTextFlow && !this.annotationElementId) ||
      (t.hidden = !1);
    this.#Dr(e, i);
    this.#Qa();
    if (!this.#Mr) {
...
class AnnotationEditorLayer {
  ...
  static #z = new Map([FreeTextEditor, InkEditor, StampEditor, HighlightEditor].map((t) => [t._editorType, t]));
  constructor({
    uiManager: t,
    pageIndex: e,
    div: i,
  ...
  updateMode(t = this.#m.getMode()) {
    ...
    for (const i of AnnotationEditorLayer.#z.values()) e.toggle(`${i._type}Editing`, t === i._editorType);
    this.div.hidden = !1;
  }
  hasTextLayer(t) {
  ...
  #qr(t) {
    ...
    if (
      e === this.#Gr.div ||
      (("img" === e.getAttribute("role") || e.classList.contains("endOfContent")) && this.#Gr.div.contains(e))
    ) {
      const { isMac: e } = util_FeatureTest.platform;
      ...
      this.toggleDrawing();
      HighlightEditor.startHighlighting(this, "ltr" === this.#m.direction, { target: this.#Gr.div, x: t.x, y: t.y });
  ...
  async deserialize(t) {
    return (
      (await AnnotationEditorLayer.#z.get(t.annotationType ?? t.annotationEditorType)?.deserialize(t, this, this.#m)) ||
      null
    );
  }
  createAndAddNewEditor(t, e, i = {}) {
    const s = this.getNextId(),
      n = this.#Kr({ parent: this, id: s, x: t.offsetX, y: t.offsetY, uiManager: this.#m, isCentered: e, ...i });
    n && this.add(n);
    return n;
  }
  #Yr() {
