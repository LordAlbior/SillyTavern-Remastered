...
!((t, e) => {
  ...
  function C(e, t) {
    ...
    return (
      Object.getOwnPropertySymbols &&
        ...
        t && (i = i.filter((t) => Object.getOwnPropertyDescriptor(e, t).enumerable)),
        a.push.apply(a, i)),
      a
    );
  }
  ...
  function R(t, e) {
    ...
    return (
      o && h
        ? ((i = n * a), ("contain" === e && t < i) || ("cover" === e && i < t) ? (n = t / a) : (t = n * a))
        : o
          ? (n = t / a)
          : h && (t = n * a),
      { width: t, height: n }
  ...
  var t = {
      ...
      initContainer: function () {
        var t = this.element,
          ...
          n =
            (v(a, L),
            X(t, L),
            { width: Math.max(i.offsetWidth, 0 <= n ? n : 200), height: Math.max(i.offsetHeight, 0 <= e ? e : 100) });
            ...
            ((s ? 0 : 1) < h
              ? ((r = a.width - n.width),
                ...
                s &&
                  ...
                  (n.maxTop = o.top),
                  2 === h) &&
                  (n.width >= a.width && ((n.minLeft = Math.min(0, r)), (n.maxLeft = Math.max(0, r))),
                  n.height >= a.height) &&
      ...
      renderCanvas: function (t, e) {
        ...
        e &&
          ...
          (h.oldLeft = h.left),
          (h.oldTop = h.top),
          f(this.canvas, g({ width: h.width, height: h.height }, x({ translateX: h.left, translateY: h.top }))),
          this.renderImage(t),
      ...
      renderImage: function (t) {
        ...
        g(i, { width: a, height: n, left: (e.width - a) / 2, top: (e.height - n) / 2 }),
          f(this.image, g({ width: i.width, height: i.height }, x(g({ translateX: i.left, translateY: i.top }, i)))),
          t && this.output();
      },
        ...
        t &&
          ...
          e &&
            (s
              ...
              : ((r.minLeft = 0), (r.minTop = 0), (r.maxLeft = o.width - r.width), (r.maxTop = o.height - r.height)));
      },
      renderCropBox: function () {
        ...
        (i.width > i.maxWidth || i.width < i.minWidth) && (i.left = i.oldLeft),
          ...
          (i.oldLeft = i.left),
          (i.oldTop = i.top),
          t.movable && t.cropBoxMovable && w(this.face, d, i.width >= e.width && i.height >= e.height ? U : P),
          f(this.cropBox, g({ width: i.width, height: i.height }, x({ translateX: i.left, translateY: i.top }))),
    ...
    i = {
      initPreview: function () {
        ...
        i && (o.crossOrigin = i),
          ...
          (this.viewBoxImage = o),
          e &&
            ("string" == typeof (o = e) ? (o = t.ownerDocument.querySelectorAll(e)) : e.querySelector && (o = [e]),
            z((this.previews = o), (t) => {
      ...
      preview: function () {
        ...
        this.cropped &&
          !this.disabled &&
          (f(this.viewBoxImage, g({ width: c, height: d }, x(g({ translateX: -l, translateY: -p }, h)))),
          z(this.previews, (t) => {
            var e = Dt(t, m),
              i = e.width,
              e = e.height,
            ...
            r && (n = s * (o = i / r)),
              ...
              f(
                ...
                g({ width: c * o, height: d * o }, x(g({ translateX: -l * o, translateY: -p * o }, h))),
              );
          }));
      },
    },
    ...
    Rt = {
      resize: function () {
        ...
        this.disabled ||
          ...
          1 != (n = Math.abs(i - 1) > Math.abs(a - 1) ? i : a) &&
            (t.restore && ((o = this.getCanvasData()), (h = this.getCropBoxData())), this.render(), t.restore) &&
            (this.setCanvasData(
              z(o, (t, e) => {
                o[e] = t * n;
              }),
      ...
      wheel: function (t) {
        var i = Number(this.options.wheelZoomRatio) || 0.1,
          a = 1;
        this.disabled ||
      ...
      cropMove: function (t) {
        ...
        !this.disabled &&
          i &&
          ((e = this.pointers), t.preventDefault(), !1 !== y(this.element, et, { originalEvent: t, action: i })) &&
          (t.changedTouches
            ? z(t.changedTouches, (t) => {
      ...
      cropEnd: function (t) {
        ...
        this.disabled ||
          ...
          e &&
            ...
            this.cropping && ((this.cropping = !1), r(this.dragBox, n, this.cropped && this.options.modal)),
      ...
      change: function (t) {
        ...
        switch (d) {
          ...
          case B:
            0 <= D.x && (y <= f || (l && (m <= b || x <= v)))
              ? (M = !1)
              : (e(B), (u += D.x) < 0 && ((d = k), (p -= u = -u)), l && (m += (s.height - (g = u / l)) / 2));
            break;
          case T:
            D.y <= 0 && (m <= b || (l && (p <= w || y <= f)))
              ? (M = !1)
          ...
          case O:
            0 <= D.y && (x <= v || (l && (p <= w || y <= f)))
              ? (M = !1)
              : (e(O), (g += D.y) < 0 && ((d = T), (m -= g = -g)), l && (p += (s.width - (u = g * l)) / 2));
            break;
          case E:
            if (l) {
              if (D.y <= 0 && (m <= b || y <= f)) {
          ...
          case I:
            D.x && D.y
              ? ((i = Et(this.cropper)),
                ...
                D.y < 0 && (m -= g),
                this.cropped || (X(this.cropBox, L), (this.cropped = !0), this.limited && this.limitCropBox(!0, !0)))
              : (M = !1);
        }
        M && ((s.width = u), (s.height = g), (s.left = p), (s.top = m), (this.action = d), this.renderCropBox()),
          z(c, (t) => {
    ...
    At = {
      ...
      destroy: function () {
        var t = this.element;
        return (
          t[c] && ((t[c] = void 0), this.isImg && this.replaced && (t.src = this.originalUrl), this.uncreate()), this
        );
      },
      move: function (t) {
      ...
      zoomTo: function (t, e, i) {
        ...
        if (0 <= (t = Number(t)) && this.ready && !this.disabled && h.zoomable) {
          (h = d * t), (l = l * t);
          if (!1 === y(this.element, rt, { ratio: t, oldRatio: s / d, originalEvent: i })) return this;
          i
            ? ((t = this.pointers),
              (d = Et(this.cropper)),
              (t =
      ...
      setData: function (t) {
        ...
        return (
          this.ready &&
            ...
            u(t) &&
            ((e = !1),
            i.rotatable && p(t.rotate) && t.rotate !== a.rotate && ((a.rotate = t.rotate), (e = !0)),
            i.scalable &&
              (p(t.scaleX) && t.scaleX !== a.scaleX && ((a.scaleX = t.scaleX), (e = !0)), p(t.scaleY)) &&
              t.scaleY !== a.scaleY &&
      ...
      getCanvasData: function () {
        ...
        return (
          this.ready &&
            z(["left", "top", "width", "height", "naturalWidth", "naturalHeight"], (t) => {
              i[t] = e[t];
            }),
          i
        );
      ...
      getCropBoxData: function () {
        var t,
          e = this.cropBoxData;
        return (
          (t = this.ready && this.cropped ? { left: e.left, top: e.top, width: e.width, height: e.height } : t) || {}
        );
      },
      ...
      getCroppedCanvas: function () {
        ...
        return this.ready && window.HTMLCanvasElement
          ? ((B = this.canvasData),
            ...
            f.drawImage.apply(f, [u].concat(j(g.map((t) => Math.floor(Y(t)))))),
            f.restore(),
            (t = w),
            this.cropped
              ? ((e = (v = this.getData()).x),
                ...
                (a = v.width),
                (n = v.height),
                1 != (o = t.width / Math.floor(B.naturalWidth)) && ((e *= o), (i *= o), (a *= o), (n *= o)),
                (h = R({ aspectRatio: (k = a / n), width: O.maxWidth || 1 / 0, height: O.maxHeight || 1 / 0 })),
                (r = R({ aspectRatio: k, width: O.minWidth || 0, height: O.minHeight || 0 }, "cover")),
                (c = (s = R({
                  aspectRatio: k,
                ...
                p.drawImage.apply(p, [t].concat(j(B.map((t) => Math.floor(Y(t)))))),
                l)
              : t)
          : null;
      },
    ...
    Pt = (() => {
      ...
      return (
        (t = n),
        (i = [
          { key: "noConflict", value: () => ((window.Cropper = jt), n) },
          {
            key: "setDefaults",
            value: (t) => {
              g(mt, u(t) && t);
                ...
                i.checkOrientation && window.ArrayBuffer
                  ? dt.test(t)
                    ...
                    : ((o = new XMLHttpRequest()),
                      ...
                      (o.onload = () => {
                        this.read(o.response);
                      }),
                      (o.onloadend = () => {
                        (this.reloading = !1), (this.xhr = null);
                      }),
