...
!((n) => {
  ...
  var e,
    ...
    s =
      (((u = t && t.fn && t.fn.select2 && t.fn.select2.amd ? t.fn.select2.amd : u) && u.requirejs) ||
        ...
        (h = (e, t) => {
          ...
          return (
            ...
            r && (n = x((r = l(r, t)))),
            r
              ? (e = n && n.normalize ? n.normalize(e, ((s = t), (e) => l(e, s))) : l(e, t))
        ...
        (f = {
          ...
          module: (e) => ({
            ...
            uri: "",
            exports: g[e],
            config: ((t = e), () => (y && y.config && y.config[t]) || {}),
          }),
        }),
        (r = (e, t, n, s) => {
          var i,
      ...
      u.define("select2/utils", ["jquery"], (r) => {
        var s = {};
        function c(e) {
          var t,
            n = e.prototype,
        ...
        (e.prototype.on = function (e, t) {
          ...
          (s.escapeMarkup = (e) => {
            ...
            return "string" != typeof e ? e : String(e).replace(/[&<>"'/\\]/g, (e) => t[e]);
          }),
          (s.__cache = {});
        var n = 0;
        return (
          (s.GetUniqueElementId = (e) => {
          ...
          (s.copyNonInternalCssClasses = (e, t) => {
            var n = (n = e.getAttribute("class").trim().split(/\s+/)).filter((e) => 0 === e.indexOf("select2-")),
      ...
      u.define("select2/results", ["jquery", "./utils"], (d, p) => {
        ...
        return (
          ...
          (s.prototype.setClasses = function () {
            this.data.current((e) => {
              var s = e.map((e) => e.id.toString());
              this.$results.find(".select2-results__option--selectable").each(function () {
                var e = d(this),
      ...
      u.define("select2/selection/base", ["jquery", "../utils", "../keys"], (n, s, i) => {
        function r(e, t) {
        ...
        return (
          ...
          (r.prototype.bind = function (e, t) {
            ...
            (this.container = e),
              ...
              this.$selection.on("keydown", (e) => {
                this.trigger("keypress", e), e.which === i.SPACE && e.preventDefault();
              }),
              e.on("results:focus", (e) => {
                this.$selection.attr("aria-activedescendant", e.data._resultId);
              }),
              ...
              e.on("open", () => {
                this.$selection.attr("aria-expanded", "true"),
                  this.$selection.attr("aria-owns", s),
              ...
              e.on("enable", () => {
                this.$selection.attr("tabindex", this._tabindex), this.$selection.attr("aria-disabled", "false");
              }),
              e.on("disable", () => {
                this.$selection.attr("tabindex", "-1"), this.$selection.attr("aria-disabled", "true");
              });
          }),
          (r.prototype._handleBlur = function (e) {
            window.setTimeout(() => {
              document.activeElement == this.$selection[0] ||
                n.contains(this.$selection[0], document.activeElement) ||
                this.trigger("blur", e);
            }, 1);
          }),
          (r.prototype._attachCloseHandler = (e) => {
            n(document.body).on("mousedown.select2." + e.id, (e) => {
          ...
          (r.prototype._detachCloseHandler = (e) => {
            n(document.body).off("mousedown.select2." + e.id);
          }),
          (r.prototype.position = (e, t) => {
            t.find(".selection").append(e);
          }),
          (r.prototype.destroy = function () {
            this._detachCloseHandler(this.container);
          }),
          (r.prototype.update = (e) => {
      ...
      u.define("select2/selection/single", ["jquery", "./base", "../utils", "../keys"], (e, t, n, s) => {
        ...
        return (
          ...
          (i.prototype.bind = function (t, e) {
            ...
            this.$selection
              ...
              this.$selection.on("mousedown", (e) => {
                1 === e.which && this.trigger("toggle", { originalEvent: e });
              }),
              this.$selection.on("focus", (e) => {}),
              this.$selection.on("blur", (e) => {}),
              t.on("focus", (e) => {
                t.isOpen() || this.$selection.trigger("focus");
              });
          }),
          ...
          (i.prototype.selectionContainer = () => e("<span></span>")),
        ...
        return (
          ...
          (r.prototype.bind = function (e, t) {
            ...
            this.$selection.find(".select2-selection__rendered").attr("id", s),
              ...
              this.$selection.on("keydown", ".select2-selection__choice__remove", (e) => {
      ...
      u.define("select2/selection/placeholder", [], () => {
        function e(e, t, n) {
          (this.placeholder = this.normalizePlaceholder(n.get("placeholder"))), e.call(this, t, n);
        }
        return (
          (e.prototype.normalizePlaceholder = (e, t) => (t = "string" == typeof t ? { id: "", text: t } : t)),
      ...
      u.define("select2/selection/allowClear", ["jquery", "../keys", "../utils"], (i, s, a) => {
        function e() {}
        return (
          (e.prototype.bind = function (e, t, n) {
            e.call(this, t, n),
              ...
              this.$selection.on("mousedown", ".select2-selection__clear", (e) => {
                this._handleClear(e);
              }),
              t.on("keypress", (e) => {
        ...
        return (
          ...
          (e.prototype.bind = function (e, t, n) {
            var i = t.id + "-results",
              r = t.id + "-container";
            e.call(this, t, n),
              this.$search.attr("aria-describedby", r),
              t.on("open", () => {
                this.$search.attr("aria-controls", i), this.$search.trigger("focus");
              }),
              t.on("close", () => {
                this.$search.val(""),
                  this.resizeSearch(),
              ...
              t.on("enable", () => {
                this.$search.prop("disabled", !1), this._transferTabIndex();
              }),
              t.on("disable", () => {
              ...
              t.on("results:focus", (e) => {
                e.data._resultId
                  ? this.$search.attr("aria-activedescendant", e.data._resultId)
                  : this.$search.removeAttr("aria-activedescendant");
              }),
              this.$selection.on("focusin", ".select2-search--inline", (e) => {
                this.trigger("focus", e);
              }),
              this.$selection.on("focusout", ".select2-search--inline", (e) => {
                this._handleBlur(e);
              }),
              this.$selection.on("keydown", ".select2-search--inline", (e) => {
                var t;
                e.stopPropagation(),
                  this.trigger("keypress", e),
                  (this._keyUpPrevented = e.isDefaultPrevented()),
                  e.which !== l.BACKSPACE ||
                    "" !== this.$search.val() ||
                    (0 < (t = this.$selection.find(".select2-selection__choice").last()).length &&
                      ((t = a.GetData(t[0], "data")), this.searchRemoveChoice(t), e.preventDefault()));
              }),
              this.$selection.on("click", ".select2-search--inline", (e) => {
                this.$search.val() && e.stopPropagation();
              });
            var t = document.documentMode,
              o = t && t <= 11;
            this.$selection.on("input.searchcheck", ".select2-search--inline", (e) => {
              o ? this.$selection.off("input.search input.searchcheck") : this.$selection.off("keyup.search");
            }),
              this.$selection.on("keyup.search input.search", ".select2-search--inline", (e) => {
                var t;
                o && "input" === e.type
                  ? this.$selection.off("input.search input.searchcheck")
                  : (t = e.which) != l.SHIFT && t != l.CTRL && t != l.ALT && t != l.TAB && this.handleSearch(e);
              });
          }),
      ...
      u.define("select2/translation", ["jquery", "require"], (t, n) => {
        function s(e) {
          this.dict = e || {};
        }
        return (
      ...
      u.define("select2/data/base", ["../utils"], (n) => {
        function s(e, t) {
          s.__super__.constructor.call(this);
        }
        return (
          n.Extend(s, n.Observable),
          (s.prototype.current = (e) => {
            throw new Error("The `current` method must be defined in child classes.");
          }),
          (s.prototype.query = (e, t) => {
            throw new Error("The `query` method must be defined in child classes.");
          }),
          (s.prototype.bind = (e, t) => {}),
          (s.prototype.destroy = () => {}),
          (s.prototype.generateResultId = (e, t) => {
            e = e.id + "-result-";
            return (
              (e += n.generateChars(4)),
      ...
      u.define("select2/data/select", ["./base", "../utils", "jquery"], (e, a, l) => {
        function n(e, t) {
        ...
        return (
          ...
          (n.prototype.current = function (e) {
            e(Array.prototype.map.call(this.$element[0].querySelectorAll(":checked"), (e) => this.item(l(e))));
          }),
      ...
      u.define("select2/data/array", ["./select", "../utils", "jquery"], (e, t, c) => {
        ...
        return (
          ...
          (s.prototype.select = function (n) {
            var e = this.$element.find("option").filter((e, t) => t.value == n.id.toString());
      ...
      u.define("select2/data/ajax", ["./array", "../utils", "jquery"], (e, t, r) => {
        function n(e, t) {
        ...
        return (
          t.Extend(n, e),
          (n.prototype._applyDefaults = (e) => {
            var t = {
              data: (e) => r.extend({}, e, { q: e.term }),
              transport: (e, t, n) => {
                e = r.ajax(e);
          ...
          (n.prototype.processResults = (e) => e),
      ...
      u.define("select2/data/tags", ["jquery"], (t) => {
        function e(e, t, n) {
          var s = n.get("tags"),
            i = n.get("createTag");
        ...
        return (
          ...
          (e.prototype.createTag = (e, t) => {
            if (null == t.term) return null;
            t = t.term.trim();
            return "" === t ? null : { id: t, text: t };
          }),
          (e.prototype.insertTag = (e, t, n) => {
            t.unshift(n);
          }),
      ...
      u.define("select2/data/tokenizer", ["jquery"], (c) => {
        ...
        return (
          ...
          (e.prototype.query = function (e, t, n) {
            t.term = t.term || "";
            var i = this.tokenizer(t, this.options, (e) => {
              var t,
                n = this._normalizeItem(e);
              this.$element.find("option").filter(function () {
                return c(this).val() === n.id;
              }).length ||
                ((t = this.option(n)).attr("data-select2-tag", !0), this._removeOldTags(), this.addOptions([t])),
                (t = n),
          ...
          (e.prototype.tokenizer = function (e, t, n, s) {
            for (
              var i = n.get("tokenSeparators") || [],
                r = t.term,
                o = 0,
                a = this.createTag || ((e) => ({ id: e.term, text: e.term }));
              o < r.length;
            ) {
              var l = r[o];
              -1 !== i.indexOf(l)
      ...
      u.define("select2/data/minimumInputLength", [], () => {
        function e(e, t, n) {
      ...
      u.define("select2/data/maximumSelectionLength", [], () => {
        ...
        return (
          ...
          (e.prototype._checkIfMaximumSelected = function (e, t) {
            this.current((e) => {
              e = null != e ? e.length : 0;
              0 < this.maximumSelectionLength && e >= this.maximumSelectionLength
                ? this.trigger("results:message", {
                    message: "maximumSelected",
                    args: { maximum: this.maximumSelectionLength },
                  })
                : t && t();
            });
          }),
      ...
      u.define("select2/dropdown", ["jquery", "./utils"], (t, e) => {
        function n(e, t) {
          (this.$element = e), (this.options = t), n.__super__.constructor.call(this);
        }
        return (
      ...
      u.define("select2/dropdown/search", ["jquery"], (r) => {
        function e() {}
        return (
          (e.prototype.render = function (e) {
            var t = e.call(this),
          ...
          (e.prototype.bind = function (e, t, n) {
            ...
            e.call(this, t, n),
              this.$search.on("keydown", (e) => {
                this.trigger("keypress", e), (this._keyUpPrevented = e.isDefaultPrevented());
              }),
              ...
              t.on("open", () => {
                this.$search.attr("tabindex", 0),
                  this.$search.attr("aria-controls", i),
                  this.$search.trigger("focus"),
                  window.setTimeout(() => {
                    this.$search.trigger("focus");
                  }, 0);
              ...
              t.on("focus", () => {
                t.isOpen() || this.$search.trigger("focus");
              }),
              t.on("results:all", (e) => {
                (null != e.query.term && "" !== e.query.term) ||
                  (this.showSearch(e)
                    ? this.$searchContainer[0].classList.remove("select2-search--hide")
                    : this.$searchContainer[0].classList.add("select2-search--hide"));
              }),
              t.on("results:focus", (e) => {
                e.data._resultId
                  ? this.$search.attr("aria-activedescendant", e.data._resultId)
          ...
          (e.prototype.showSearch = (e, t) => !0),
          e
        );
      }),
      u.define("select2/dropdown/hidePlaceholder", [], () => {
        function e(e, t, n, s) {
      ...
      u.define("select2/dropdown/infiniteScroll", ["jquery"], (n) => {
        function e(e, t, n, s) {
          (this.lastParams = {}),
            e.call(this, t, n, s),
        ...
        return (
          ...
          (e.prototype.showLoadingMore = (e, t) => t.pagination && t.pagination.more),
      ...
      u.define("select2/dropdown/attachBody", ["jquery", "../utils"], (u, o) => {
        ...
        return (
          (e.prototype.bind = function (e, t, n) {
            e.call(this, t, n),
              t.on("open", () => {
                this._showDropdown(), this._attachPositioningHandler(t), this._bindContainerResultHandlers(t);
              }),
              t.on("close", () => {
                this._hideDropdown(), this._detachPositioningHandler(t);
              }),
      ...
      u.define("select2/dropdown/minimumResultsForSearch", [], () => {
        function e(e, t, n, s) {
      ...
      u.define("select2/dropdown/selectOnClose", ["../utils"], (s) => {
        function e() {}
        return (
          (e.prototype.bind = function (e, t, n) {
            e.call(this, t, n),
      ...
      u.define("select2/dropdown/closeOnSelect", [], () => {
        function e() {}
        return (
          (e.prototype.bind = function (e, t, n) {
            e.call(this, t, n),
      ...
      u.define("select2/dropdown/dropdownCss", ["../utils"], (n) => {
        function e() {}
        return (
          (e.prototype.render = function (e) {
            var t = e.call(this),
      ...
      u.define(
        ...
        (l, r, o, a, c, u, d, p, h, f, g, t, m, y, v, _, b, $, w, x, A, D, S, E, O, C, L, T, q, I, e) => {
          function n() {
            this.reset();
          }
          return (
            ...
            (n.prototype._resolveLanguage = (e) => {
              if (!e) return [];
        ...
        return (
          ...
          (o.prototype._registerDomEvents = function () {
            this.$element.on("change.select2", () => {
              ...
              this.$element.on("focus.select2", (e) => {
                this.trigger("focus", e);
              }),
              (this._syncA = r.bind(this._syncAttributes, this)),
              (this._syncS = r.bind(this._syncSubtree, this)),
              (this._observer = new window.MutationObserver((e) => {
                this._syncA(), this._syncS(e);
              })),
              this._observer.observe(this.$element[0], { attributes: !0, childList: !0, subtree: !1 });
          }),
          (o.prototype._registerDataEvents = function () {
            this.dataAdapter.on("*", (e, t) => {
              this.trigger(e, t);
            });
          }),
          (o.prototype._registerSelectionEvents = function () {
            ...
            this.selection.on("toggle", () => {
              ...
              this.selection.on("*", (e, t) => {
                -1 === s.indexOf(e) && this.trigger(e, t);
              });
          }),
          (o.prototype._registerDropdownEvents = function () {
            this.dropdown.on("*", (e, t) => {
              this.trigger(e, t);
            });
          }),
          ...
          (o.prototype._isChangeMutation = function (e) {
            if (e.addedNodes && 0 < e.addedNodes.length) {
              ...
              if (Array.isArray(e)) return e.some((e) => this._isChangeMutation(e));
            }
            return !1;
          }),
          ...
          (o.prototype.val = function (e) {
            ...
            e = e[0];
            Array.isArray(e) && (e = e.map((e) => e.toString())),
      ...
      u.define("jquery-mousewheel", ["jquery"], (e) => e),
      u.define(
        "jquery.select2",
