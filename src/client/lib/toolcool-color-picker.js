...
(() => {
  ...
  function O(o, e, t) {
    return (
      t < 0 && (t += 1),
      t > 1 && (t -= 1),
      t < 1 / 6 ? o + (e - o) * (6 * t) : t < 1 / 2 ? e : t < 2 / 3 ? o + (e - o) * (2 / 3 - t) * 6 : o
    );
  }
  function ht(o, e, t) {
    var i, r, n;
    ...
    return (
      ...
      (o.prototype.getLuminance = function () {
        var e = this.toRgb(),
          ...
          a = e.b / 255;
        return (
          n <= 0.03928 ? (t = n / 12.92) : (t = ((n + 0.055) / 1.055) ** 2.4),
          s <= 0.03928 ? (i = s / 12.92) : (i = ((s + 0.055) / 1.055) ** 2.4),
          a <= 0.03928 ? (r = a / 12.92) : (r = ((a + 0.055) / 1.055) ** 2.4),
      ...
      (o.prototype.toPercentageRgb = function () {
        var e = (t) => "".concat(Math.round(u(t, 255) * 100), "%");
        return { r: e(this.r), g: e(this.g), b: e(this.b), a: this.a };
      }),
      (o.prototype.toPercentageRgbString = function () {
        var e = (t) => Math.round(u(t, 255) * 100);
        return this.a === 1
      ...
      (o.prototype.toName = function () {
        ...
        for (var e = "#" + K(this.r, this.g, this.b, !1), t = 0, i = Object.entries(A); t < i.length; t++) {
          var r = i[t],
            n = r[0],
            s = r[1];
          if (e === s) return n;
      ...
      (o.prototype.analogous = function (e, t) {
        ...
        var i = this.toHsl(),
          r = 360 / t,
          n = [this];
        for (i.h = (i.h - ((r * e) >> 1) + 720) % 360; --e; ) (i.h = (i.h + r) % 360), n.push(new o(i));
        return n;
      }),
      ...
      (o.prototype.splitcomplement = function () {
        var e = this.toHsl(),
          t = e.h;
        return [this, new o({ h: (t + 72) % 360, s: e.s, l: e.l }), new o({ h: (t + 216) % 360, s: e.s, l: e.l })];
      }),
      (o.prototype.onBackground = function (e) {
        var t = this.toRgb(),
          i = new o(e).toRgb();
        return new o({ r: i.r + (t.r - i.r) * t.a, g: i.g + (t.g - i.g) * t.a, b: i.b + (t.b - i.b) * t.a });
      }),
  ...
  var j = class extends HTMLElement {
      ...
      onChange(t) {
        ...
        const { width: i, height: r, left: n, top: s } = this.$saturation.getBoundingClientRect();
        if (i === 0 || r === 0) return;
        const a = typeof t.clientX == "number" ? t.clientX : t.touches[0].clientX,
      ...
      connectedCallback() {
        ...
        const i = c(this.getAttribute("color")).toHsv();
        (this.hue = i.h), (this.saturation = i.s), (this.value = i.v);
        const r = W(this.value),
          n = X(this.saturation);
  ...
  var Y = class extends HTMLElement {
      ...
      hsvChanged(t) {
        !t ||
          !t.detail ||
          !t.detail.cid ||
          (t.detail.cid === this.cid && this.hue !== t.detail.h && ((this.hue = t.detail.h), this.render()));
      }
      onChange(t) {
        if (!this.$hue) return;
        t.preventDefault && t.preventDefault();
        const { width: i, left: r } = this.$hue.getBoundingClientRect();
        if (i === 0) return;
        const n = typeof t.clientX == "number" ? t.clientX : t.touches[0].clientX,
      ...
      connectedCallback() {
        ...
        if (!this.shadowRoot) return;
        this.cid = this.getAttribute("cid") || "";
        const t = c(this.getAttribute("color"));
        (this.hue = t.toHsv().h),
          (this.shadowRoot.innerHTML = `
           <style>${vt}</style>
           <div class="hue">
  ...
  var Q = class extends HTMLElement {
      ...
      render(t = !0) {
        if ((this.$pointer && (this.$pointer.style.left = `${this.alpha * 100}%`), this.$color)) {
          const i = new l({ h: this.hue, s: this.saturation, v: this.value, a: this.alpha });
      ...
      onChange(t) {
        ...
        t.preventDefault && t.preventDefault();
        const { width: i, left: r } = this.$alpha.getBoundingClientRect();
        if (i === 0) return;
        const n = typeof t.clientX == "number" ? t.clientX : t.touches[0].clientX,
          s = Math.min(Math.max(0, n - r), i),
      ...
      hsvChanged(t) {
        !t ||
          ...
          (t.detail.cid === this.cid &&
            ((this.saturation = t.detail.h), (this.hue = t.detail.s), (this.value = t.detail.v), this.render(!1)));
      }
      hueChanged(t) {
      ...
      alphaChanged(t) {
        !t ||
          !t.detail ||
          !t.detail.cid ||
          (t.detail.cid === this.cid && this.alpha !== t.detail.a && ((this.alpha = t.detail.a), this.render()));
      }
      onMouseDown(t) {
        t.preventDefault && t.preventDefault(),
          this.onChange(t),
  ...
  var J = class extends HTMLElement {
      ...
      hsvChanged(t) {
        !t ||
          ...
          !t.detail.cid ||
          (t.detail.cid === this.cid &&
            ((this.color = new l({ h: t.detail.h, s: t.detail.s, v: t.detail.v, a: this.color.toHsv().a })),
            this.render()));
      }
      render() {
        var i, r, n, s, a;
        const t = this.color.toRgb();
        (this.r = t.r),
          (this.g = t.g),
          (this.b = t.b),
          (this.a = t.a),
      ...
      onFieldKeyDown(t, i) {
        var n, s;
        const r = this.color.toRgb();
        switch (t.key) {
          case "ArrowUp": {
            if (i === "r") {
              (this.r = Math.min(255, r.r + 1)), (r.r = this.r);
              const a = new l(r).toHsv();
            ...
            if (i === "a") {
              (this.a = Math.min(100, this.a + 0.01)), (this.$a.value = Math.round(this.a * 100).toString());
              const a = this.color.toRgb();
      ...
      onHexChange(t) {
        ...
        const r = new l(`#${i.value}`);
        if (r.isValid) {
          this.color = r;
          const n = this.color.toHsv();
      ...
      onRedChange(t) {
        ...
        if (r.toString() === i.value) {
          const n = this.color.toRgb();
          n.r = r;
          const s = new l(n).toHsv();
  ...
  var Z = class extends HTMLElement {
      constructor() {
        ...
        customElements.get("toolcool-color-picker-saturation") ||
          ...
          customElements.get("toolcool-color-picker-hue") || customElements.define("toolcool-color-picker-hue", mt),
          customElements.get("toolcool-color-picker-alpha") || customElements.define("toolcool-color-picker-alpha", xt),
      ...
      attributeChangedCallback(t, i, r) {
        ...
        if (
          ...
          this.color = r;
          const w = (n = this.shadowRoot) == null ? void 0 : n.querySelector("toolcool-color-picker-saturation"),
            x = (s = this.shadowRoot) == null ? void 0 : s.querySelector("toolcool-color-picker-hue"),
            R = (a = this.shadowRoot) == null ? void 0 : a.querySelector("toolcool-color-picker-alpha"),
  ...
  var Ut = {
    ...
    tt = class extends HTMLElement {
      constructor() {
        ...
        h(this, "state");
        (this.cid = $()),
          customElements.get("toolcool-color-picker-popup") || customElements.define("toolcool-color-picker-popup", yt),
          this.attachShadow({ mode: "open" }),
      ...
      onPopupPosChange() {
        ...
        const t = this.$popupBox.querySelector("toolcool-color-picker-popup");
        !t || t.setAttribute("popup-position", this.state.popupPosition);
      }
      onInitialColorChange() {
        var r;
        const t = S(this.state.color);
        this.$buttonColor && (this.$buttonColor.style.backgroundColor = t);
        const i = (r = this.shadowRoot) == null ? void 0 : r.querySelector("toolcool-color-picker-popup");
      ...
      hsvChanged(t) {
        !t ||
          ...
          !t.detail.cid ||
          (t.detail.cid === this.cid &&
            (this.state.color = new l({ h: t.detail.h, s: t.detail.s, v: t.detail.v, a: this.state.color.toHsv().a })));
      }
      hueChanged(t) {
        if (!t || !t.detail || !t.detail.cid || t.detail.cid !== this.cid) return;
        const i = this.state.color.toHsv();
        this.state.color = new l({ h: t.detail.h, s: i.s, v: i.v, a: i.a });
      }
      alphaChanged(t) {
        if (!t || !t.detail || !t.detail.cid || t.detail.cid !== this.cid) return;
        const i = this.state.color.toRgb();
      ...
      toggle() {
        const t = this.state.isPopupVisible;
        window.setTimeout(() => {
