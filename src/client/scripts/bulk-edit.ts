...
import { BulkEditOverlay, BulkEditOverlayState, CharacterContextMenu } from "./BulkEditOverlay";
import { event_types, eventSource } from "./events";
...
function enableBulkSelect() {
  ...
  $(document).on("click", ".bulk_select_checkbox", (event) => {
