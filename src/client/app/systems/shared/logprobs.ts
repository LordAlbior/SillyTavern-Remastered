...
import { debounce, delay, getStringHash } from "/app/systems/shared/utils";
import { decodeTextTokens, getTokenizerBestMatch } from "/app/systems/ai/tokenizers";
...
function renderAlternativeTokensView() {
  ...
  if (prefix) {
    ...
    words.forEach((word: any, i: any) => {
      ...
      tokenSpans.push(
        delimiters[i]?.includes("\n") ? document.createElement("br") : document.createTextNode(delimiters[i] || " "),
      );
