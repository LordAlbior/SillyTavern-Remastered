...
import { VIDEO_EXTENSIONS } from "/app/systems/shared/constants";
...
import { humanFileSize, timestampToMoment } from "/app/systems/shared/utils";

/**
 * @typedef {object} DataMaidReportResult
 * @property {import('/app/systems/shared/data-maid').DataMaidSanitizedReport} report - The sanitized report of the Data Maid.
...
class DataMaidDialog {
   ...
   * @param {import('/app/systems/shared/data-maid').DataMaidSanitizedRecord[]} items List of items in the category
