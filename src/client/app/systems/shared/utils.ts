...
import { getContext } from '/app/systems/extensions';
...
import { collapseNewlines, power_user } from '/app/systems/power-user';
import { compareIgnoreCaseAndAccents, debounce_timeout, sortIgnoreCaseAndAccents } from '/app/systems/shared/constants';
import { Popup, POPUP_RESULT, POPUP_TYPE } from '/app/systems/ui/popup';
import { SlashCommandClosure } from '/app/systems/slash-commands/slash-commands/SlashCommandClosure';
import { getTagsList } from '/app/systems/characters/tags';
import { groups, selected_group } from '/app/systems/chat/group-chats';
import { getCurrentLocale, t } from '/app/systems/shared/i18n';
import { importWorldInfo } from '/app/systems/world-info';
...
export async function extractTextFromEpub(blob: any) {
    if (!('ePub' in window)) {
        await import('/lib/jszip.min');
        await import('/lib/epub.min');
    }
