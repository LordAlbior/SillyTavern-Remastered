...
const basicAuthMiddleware = async (request: import("express").Request, response: import("express").Response, callback: () => void) => {
  const unauthorizedResponse = (res: import("express").Response) => {
