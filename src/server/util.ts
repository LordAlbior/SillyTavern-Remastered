...
import { LOG_LEVELS, CHAT_COMPLETION_SOURCES, MEDIA_REQUEST_TYPE } from "./constants";
import { serverDirectory } from "./server-directory";
import { sync as writeFileAtomicSync } from "write-file-atomic";
import { isFirefox } from "./express-common";
 ...
 */
export function getConfigValue(key: string, defaultValue: unknown = null, typeConverter: unknown = null): any {
  function _getValue() {
