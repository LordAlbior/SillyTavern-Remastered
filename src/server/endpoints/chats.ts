...
import validateAvatarUrlMiddleware from "../middleware/validateFileName";
import {
  getConfigValue,
  humanizedDateTime,
  tryParse,
...
function getPreviewMessage(lastMessage: string) {
  ...
  return lastMessage.length > strlen ? "..." + lastMessage.substring(lastMessage.length - strlen) : lastMessage;
}
...
router.post("/save", validateAvatarUrlMiddleware, async (request, response) => {
  try {
...
router.post("/get", validateAvatarUrlMiddleware, (request, response) => {
  try {
...
router.post("/delete", validateAvatarUrlMiddleware, (request, response) => {
  try {
...
router.post("/group/import", (request, response) => {
  try {
...
router.post("/import", validateAvatarUrlMiddleware, (request, response) => {
...
router.post("/search", validateAvatarUrlMiddleware, async (request, response) => {
  try {
...
router.post("/recent", async (request, response) => {
  try {
    ...
    /** @type {import('../../scripts/welcome-screen.js').PinnedChat[]} */
