export const PUBLIC_DIRECTORIES = {
  ...
  backups: "backups/",
  sounds: "src/client/sounds",
  extensions: "src/client/extensions",
  globalExtensions: "src/client/scripts/extensions/third-party",
};
...
export const DEFAULT_AVATAR_PATH = "./client/img/ai4.png";
